  ...
  const utilities = [
    {
      id: 'phone',
      title: 'Հեռախոս',
      icon: 'https://resource.evoca.am/images/WebPayment/phone.png',
      link: '#',
    },
    {
      id: 'electricity',
      title: 'Լույս',
      icon: 'https://resource.evoca.am/images/WebPayment/electricity.png',
      link: '#',
    },
    {
      id: 'water',
      title: 'Ջուր',
      icon: 'https://resource.evoca.am/images/WebPayment/water.png',
      link: '#',
    },
    {
      id: 'gas_consumption',
      title: 'Գազի սպառում',
      icon: 'https://resource.evoca.am/images/WebPayment/gas.png',
      link: '#',
    },
    {
      id: 'gas_service',
      title: 'Գազի սպասարկում',
      icon: 'https://resource.evoca.am/images/WebPayment/gas_service.png',
      link: '#',
    },
  ];
    ...
    <div className="min-h-screen bg-[#f8f7fc] text-gray-800 font-sans flex flex-col justify-between">
      ...
      <main className="max-w-5xl mx-auto px-4 py-8 w-full">
        ...
        <nav className="flex items-center gap-2 text-xs sm:text-sm mb-8 justify-center sm:justify-start">
          ...
          <span className="text-gray-500 font-medium">Կոմունալ վճարումներ</span>
        </nav>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-4xl mx-auto">
          {utilities.map((item) => (
            <Link
              key={item.id}
              to={item.link}
              className="flex flex-col items-center justify-center p-8 rounded-3xl cursor-pointer min-h-[200px] text-center bg-white border border-transparent transition-all duration-300 hover:bg-[#e8e0fc] hover:border-[#8c46ff] hover:shadow-md"
            >
              <div className="mb-6 h-16 flex items-center justify-center">
                <img 
                  ...
                  onError={(e) => {
                    ...
                    e.target.src = 'https://via.placeholder.com/80?text=Icon';
                  }}
                />
              </div>
