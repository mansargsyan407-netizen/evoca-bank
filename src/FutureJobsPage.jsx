...
const jobsList = [
  {
    id: 1,
    title: "IT մասնագետ",
    description: "Բիզնեսի, ֆինանսական համակարգերի և արդյունաբերական տեխնոլոգիաների զարգացմանը զուգընթաց մեծանում է նորարարական ծրագրեր ստեղծելու անհրաժեշտությունն ու լավ մասնագետների պահանջը: Ենթադրվում է, որ արդեն 2026-ին համաշխարհային շուկայում 1.2մլն նոր մասնագետի պահանջ կլինի:"
  },
  {
    id: 2,
    title: "Թվային մարքեթինգի մասնագետ",
    description: "Աշխարհը դառնում է թվային: Օրեցօր կատարելագործվող սպառողական շուկայում թվային կոնտենտի կառավարման մասնագետների անսպառ պահանջ կա, որոնք կգտնեն նոր հաճախորդներ:"
  },
  {
    id: 3,
    title: "Տվյալագետ",
    description: "Տվյալագիտությունը կիրառելի է առողջապահության, գյուղատնտեսության, բանկային և մի շարք այլ ոլորտներում:\nՏվյալագետը, օգտագործելով մաթեմատիկական, վիճակագրական մեթոդները և ալգորիթմները, տվյալների հիման վրա բացահայտում է օրինաչափություններ և իրականացնում կանխատեսումներ, որոնք անմիջականորեն կարող են օգտագործվել պրակտիկայում և բիզնեսում:\nԱյս մասնագիտությունն այսօր արդեն իսկ խիստ պահանջված է և ակտուալ:"
  },
  {
    id: 4,
    title: "3D տպագրության տեխնոլոգիա",
    description: "Այս նոր տեխնոլոգիան գնալով լայն տարածում է ստանում և օգտագործվում է «նախատիպեր» ստեղծելու և վաճառքի համար: 3D տպագրությունն ավելի լայնորեն կիրառվում է կենսաբժշկական, ավիացիոն, ավտոմոբիլային արդյունաբերության և շատ այլ ոլորտներում:"
  },
  {
    id: 5,
    title: "Քամու և արևային էներգիայի մասնագետ",
    description: "Կլիմայի փոփոխությանը համընթաց մեծանում է մաքուր էներգիայի ստեղծման անհրաժեշտությունը: Քամու և արևային էներգիան մարդկությանապագան են թե' կլիմայի պահպանման և թե' գումար խնայելու տեսանկյունից:"
  },
  {
    id: 6,
    title: "Կիբեռանվտանգության մասնագետ",
    description: "ՏՏ անվտանգությունը համակարգչային համակարգերի պաշտպանությունն է:\nԿիբեռանվտանգության դաշտը դառնում է առավել կարևոր համակարգչային համակարգերի' ինտերնետից կախվածությունը մեծացնելու պատճառով, սմարթֆոնների, հեռուստացույցների և այլ սարքավորումների աճի շնորհիվ:"
  },
  {
    id: 7,
    title: "IT բժիշկ",
    description: "Մասնագետ, որը կատարյալ տիրապետում է բժշկությանն ու ծրագրավորմանը: Մոտ ապագայում հիվանդն այլևս կարիք չի ունենա հասնել հիվանդանոց և սպասել: Ցանկացած անձ կկարողանա online համակարգով պատմել ինքնազգացողության մասին և անմիջապես ստանալ թե' բժշկի խորհրդատվություն և թե' անհրաժեշտ դեղեր:"
  },
  {
    id: 8,
    title: "Ֆիզիոթերապևտ",
    description: "Կյանքի որակի զգալի փոփոխման արդյունքում մեծանում է պրոֆեսիոնալ ֆիզիոթերապևտների պահանջը: Անընդհատ լարված և նստակյաց աշխատանքից հետո շատերն են զգում մասնագիտական մերսման կարիք:"
  }
];

const futureSpecialJobs = [
  {
    id: 9,
    title: "Տիեզերական տուրիզմի էքսկուրսավար",
    description: "Մոտակա 10 տարում մեզ հաստատ պետք կլինեն էքսկուրսավարներ, որոնք կներկայացնեն տուրիստներին Տիեզերքի տեսարժան վայրերը:"
  },
  {
    id: 10,
    title: "Թվային լեզվաբան",
    description: "Ապագայի այս մասնագիտությունը մեքենայի լեզուն հասկանալի և կենդանի կդարձնի մարդկանց համար: Թվային լեզվաբանները կաշխատեն online թարգմանիչների, որոնողական համակարգերի և այն ռոբոտների հետ, որոնք «կխոսեն» մարդկանց հետ:"
  }
];
  ...
  return (
    <div className="min-h-screen bg-white text-gray-800 font-sans pb-16">
      ...
      <div className="max-w-5xl mx-auto px-4 py-4 text-xs text-gray-500 flex items-center gap-2">
        ...
        <span>›</span>
        <span className="text-gray-400 truncate max-w-xs">Ապագայի ամենապահանջված մասնագիտությունները</span>
      </div>
      ...
      <main className="max-w-5xl mx-auto px-4 py-6">
        ...
        <div className="bg-[#f5f4f8] rounded-3xl p-6 md:p-10 flex flex-col md:flex-row gap-8 items-center justify-between">
          <div className="md:w-1/2 space-y-4">
            ...
            <h1 className="text-2xl md:text-3xl font-extrabold text-[#222222] leading-tight">
              Ապագայի ամենապահանջված մասնագիտությունները
            </h1>
            <p className="text-sm text-gray-600 leading-relaxed">
              Օրեցօր զարգացող աշխարհը ստիպում է մարդկանց ընտրել այնպիսի մասնագիտություններ, որոնք մոտակա տարիներին կլինեն ակտուալ և պահանջված:
            </p>
          ...
          <div className="md:w-1/2 w-full">
            <div className="overflow-hidden rounded-2xl shadow-md">
              <img
                src="https://www.evoca.am/images-cache/blogs/1/16335957379/438x328.png"
                alt="Ապագայի ամենապահանջված մասնագիտությունները"
        ...
        <div className="mt-8">
          <p className="text-sm text-gray-700 font-medium">
            Կիսվենք ձեզ հետ ամենապահանջված մասնագիտություններով՝
          </p>
        </div>
        ...
        <div className="mt-6 space-y-6 max-w-4xl">
          {jobsList.map((job) => (
            <div key={job.id} className="space-y-1">
              <h2 className="text-base font-bold text-[#8c30d2]">
                {job.title}
              </h2>
        ...
        {/* Special 2 Future Jobs Section */}
        <div className="mt-10 max-w-4xl">
          <p className="text-sm text-gray-700 font-medium mb-4">
            Իսկ ապագայի 2 հետաքրքիր մասնագիտություններից նշենք՝
          </p>

          <div className="space-y-6">
            {futureSpecialJobs.map((job) => (
              <div key={job.id} className="space-y-1">
                <h2 className="text-base font-bold text-[#8c30d2]">
                  {job.title}
                </h2>
        ...
        {/* Conclusion Text */}
        <div className="mt-10 max-w-4xl space-y-4 border-t border-gray-100 pt-6">
          <p className="text-sm text-gray-700 leading-relaxed">
            Այսօր զարգացման ռիթմն ամենամեծ խնդիրներն առաջացրել է կրթական ոլորտում, քանի որ կրթական հաստատություններում դասավանդվող գիտելիքները պարբերաբար հնացած են դառնում:
          </p>
          <p className="text-sm font-semibold text-gray-800">
            Այդ պատճառով շատ կարևոր է ինքնակրթումը և ինքնազարգացումը:
          </p>
        </div>
