...
export default function LoanCard({ currentLoanId = 9 }) {
  ...
  // 13 Պայմանների տվյալների զանգված
  const loanTerms = [
    {
      id: 1,
      title: 'Ովքեր կարող են դիմել',
      content: 'Բանկի վճարային քարտի միջոցով աշխատավարձ ստացող՝ 18 – 65 տարեկան ՀՀ ռեզիդենտ ֆիզիկական անձինք, ովքեր վարկի սպասարկման ողջ ընթացքում չեն բոլորի 65 տարին',
    },
    {
      id: 2,
      title: 'Վարկավորման ձև',
      content: (
        <ul className="list-disc pl-5 space-y-1">
          <li>Վերականգնվող` ամսական նվազագույն մարման պահանջով օվերդրաֆտ</li>
          <li>Անուիտետային մարման գրաֆիկով վարկ</li>
        </ul>
      ),
    },
    {
      ...
      content: '100,000 - 10,000,000 ՀՀ դրամ, ոչ ավել քան փոխանցվող աշխատավարձի տասնհինգապատիկ',
    },
    {
      id: 4,
      title: 'Մարման ժամկետ',
    ...
    },
    {
      ...
      content: (
        <ul className="list-disc pl-5 space-y-1">
          <li>Օվերդրաֆտը տրամադրվում է Բանկի վճարային քարտերի միջոցով</li>
          <li>Մարման գրաֆիկով վարկը կարող է անկանխիկ տրամադրվել նաև ընթացիկ բանկային հաշվին</li>
        </ul>
      ),
    },
    {
      ...
      content: (
        <ul className="list-disc pl-5 space-y-1">
          <li>Մարման գրաֆիկով վարկի դեպքում սահմանվում է հաճախորդի կողմից</li>
          <li>Օվերդրաֆտի դեպքում՝ յուրաքանչյուր ամսվա 16-ը (եթե տվյալ ամսվա 16-ը հանդիսանում է ոչ աշխատանքային օր, ապա վերջնաժամկետ է համարվում հաջորդ աշխատանքային օրը)</li>
        </ul>
      ),
    },
    {
      id: 9,
      title: 'Քաղվածքի օր',
      content: 'Մինչև յուրաքանչյուր ամսվա 10-ը',
    },
    {
      id: 10,
      title: 'Տույժեր',
      content: (
        <ul className="list-disc pl-5 space-y-1">
          <li>Ամսական նվազագույն վճարը կամ մայր գումարը վճարման ժամկետին չվճարելու տույժ` 0.015% օրական</li>
          <li>Հաշվեգրված տոկոսները վճարման ժամկետին չվճարելու տույժ` 0.1% օրական</li>
        </ul>
      ),
    },
    {
      id: 11,
      title: 'Այլ արտոնություններ',
      content: 'Անշարժ գույքի գրավով ապահովված սպառողական և ավտովարկերի դեպքում վարկի տարեկան տոկոսադրույքը կարող է նվազեցվել մինչև 0.5 տոկոսային կետով:',
    },
    {
      id: 12,
      title: 'Այլ դրույթներ',
      content: '60 և ավել օրվա ընթացքում գործատուի կողմից աշխատավարձը և/կամ դրան հավասարեցված վճարները Բանկի քարտին չփոխանցելու դեպքում, անգրավ վարկի/օվերդրաֆտի վարկային պայմանագրում նշված տարեկան տոկոսադրույքի փոխարեն կիրառվում է նշված ժամանակահատվածի լրանալու օրվա դրությամբ անգրավ վարկատեսակով սահմանված տարեկան անվանական տոկոսադրույքը գումարած մեկ տոկոսային կետ:',
    },
    {
      id: 13,
      ...
      content: (
        <ul className="list-disc pl-5 space-y-1">
          <li>Վարկի տրամադրման կամ մերժման որոշումը կայացվում է առավելագույնը 3 (երեք) աշխատանքային օրվա ընթացքում:</li>
          <li>Վարկը տրամադրվում է Բանկի կողմից դրական որոշման դեպքում, առավելագույնը 5 (հինգ) աշխատանքային օրվա ընթացքում:</li>
        </ul>
      ),
    },
  ];
  ...
  return (
    <div className="w-full font-sans select-none overflow-hidden bg-white text-gray-800 flex flex-col min-h-screen relative selection:bg-purple-500 selection:text-white">
      
      {/* 1. Մանուշակագույն Submenu / Ենթամենյու */}
      ...
      <section className="relative w-full bg-[#f8f9fe] min-h-[360px] md:min-h-[420px] flex items-center overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 md:px-12 w-full grid grid-cols-1 md:grid-cols-2 items-center gap-8 py-8 relative z-10">
          ...
          <div className="space-y-4 max-w-lg">
            ...
            <p className="text-xs md:text-sm text-gray-600 leading-relaxed">
              Աշխատավարձ ես ստանում մեր բանկային քարտով և ունե՞ս ընթացիկ ծախսերի հետ կապված խնդիրներ․ Evocabank-ը Ձեզ կտրամադրի շահավետ պայմաններով վարկ:
            </p>
          </div>

          {/* Right Visual (Yellow shape + Wallet & Cards illustration) */}
          <div className="relative flex justify-center items-center">
            <div className="w-[280px] h-[280px] sm:w-[340px] sm:h-[340px] bg-yellow-400 rounded-[4rem] transform rotate-12 absolute z-0 opacity-95"></div>
            
            <div className="relative z-10 p-4 transform -rotate-6">
              <div className="w-48 sm:w-56 h-32 sm:h-36 bg-emerald-400 rounded-3xl shadow-xl border-4 border-white flex flex-col justify-between p-4 relative">
                <div className="w-8 h-8 rounded-full bg-blue-300/60 ml-auto border-2 border-white"></div>
                <div className="w-6 h-6 rounded-full bg-yellow-300"></div>
                
                {/* Credit Cards Sticking Out */}
                <div className="absolute -top-10 right-4 w-32 h-20 bg-purple-300 rounded-xl transform rotate-12 border-2 border-white shadow-md"></div>
                <div className="absolute -top-6 right-10 w-32 h-20 bg-blue-400 rounded-xl transform -rotate-6 border-2 border-white shadow-md"></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="absolute left-0 top-1/2 -translate-y-1/2 bg-white/90 backdrop-blur-sm border border-gray-200 rounded-r-md py-3 px-1.5 flex flex-col gap-3 text-gray-500 z-30 shadow-md">
          <a href="#" className="hover:text-[#6a0dad] transition-colors" aria-label="Facebook">
            <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
              <path d="M9 8H6v4h3v12h5V12h3.642L18 8h-4V6.333C14 5.374 14.5 5 15.5 5H18V0h-3.808C10.592 0 9 1.583 9 4.615V8z"/>
            </svg>
          </a>
          <a href="#" className="hover:text-[#6a0dad] transition-colors" aria-label="LinkedIn">
            <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
      ...
      <main className="flex-grow">
        ...
        <section className="max-w-7xl mx-auto px-4 md:px-8 w-full mb-12">
          <div className="border-b border-gray-200 flex gap-8 mb-6 text-sm font-bold">
            <button
          ...
          {activeTab === 'about' ? (
            <div className="text-sm md:text-base text-gray-700 leading-relaxed max-w-3xl">
              <p>
                Աշխատավարձ ստանում ես <span className="font-bold text-[#6a0dad]">Evocabank</span>-ի քարտո՞վ։ Օգտվիր քեզ հասանելի վարկային առաջարկից և ստացիր ֆինանսավորում Բանկի կողմից քո ծրագրերն ավելի հեշտ ու արագ իրականացնելու համար։
              </p>
            </div>
          ) : (
            /* ԱՎԵԼԱՑՎԱԾ ՊԱՅՄԱՆՆԵՐԻ ԱՂՅՈՒՍԱԿԸ (13 ԿԵՏԵՐ) */
            <div className="w-full max-w-4xl overflow-hidden rounded-xl border border-gray-200 shadow-sm bg-white">
              <div className="divide-y divide-gray-200">
                {loanTerms.map((term) => (
                  <div key={term.id} className="grid grid-cols-1 md:grid-cols-3 p-4 md:p-5 hover:bg-purple-50/30 transition-colors gap-2 md:gap-4">
                    <div className="font-bold text-gray-900 text-sm md:text-base flex items-start gap-2">
                      <span className="text-[#6a0dad]">{term.id}.</span>
        ...
        {/* 2. Banner Հատվածը՝ Ֆոնային նկարով և տեքստով */}
        <section className="relative w-full h-[320px] md:h-[420px] lg:h-[480px] overflow-hidden flex items-center justify-center">
          {/* Հետևի Ֆոնի Նկարը */}
          <img
            src="https://www.evoca.am/images-cache/loans/1/16142653302181/1920x527.jpg"
            alt="Evocabank background"
            className="absolute inset-0 w-full h-full object-cover object-center"
          />

          {/* Ֆոնի վրայի տեքստը (Կենտրոնացված) */}
          <div className="relative z-10 text-center max-w-xl mx-auto px-4">
            <h1 className="text-white text-2xl md:text-4xl font-black leading-tight tracking-wide drop-shadow-md">
              Evocabank-ը կօգնի հոգալ Ձեր ընթացիկ ծախսերը:
            </h1>
          </div>

          {/* Ձախ կողմի Սոց․ ցանցերի սայդբարը */}
          <div className="absolute left-0 top-1/2 -translate-y-1/2 bg-white/90 backdrop-blur-sm border border-gray-200 rounded-r-md py-3 px-1.5 flex flex-col gap-3 text-gray-600 z-30 shadow-md">
            <a href="#" className="hover:text-[#6a0dad] transition-colors" aria-label="Facebook">
              <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                <path d="M9 8H6v4h3v12h5V12h3.642L18 8h-4V6.333C14 5.374 14.5 5 15.5 5H18V0h-3.808C10.592 0 9 1.583 9 4.615V8z"/>
              </svg>
