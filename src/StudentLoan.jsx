...
const StudentLoan = () => {
  ...
  // Պայմանների տվյալներ
  const termsList = [
    { id: 1, title: 'Ովքեր կարող են դիմել', content: '18 - 65 տարեկան ՀՀ ռեզիդենտ ֆիզիկական անձինք, ովքեր հանդիսանում են բանկի Visa Infinite քարտապան:' },
    { id: 2, title: 'Ծրագրի շահառուներ', content: 'Կառավարության 2022 թ․ փետրվարի 17-ի N 169-L, 2022 թ․ հունիսի 9-ի N 842-L և 2024 թ․ մայիսի 16-ի N 710-L որոշումներով սահմանված անձիք:' },
    { id: 3, title: 'Վարկավորման նպատակը', content: 'Ծրագրերի շրջանակում ձեռքբերված բնակարանի/բնակելի տան, կառուցված բնակելի տան վերանորոգում' },
    { id: 4, title: 'Վարկավորման արժույթը', content: 'ՀՀ դրամ' },
    { id: 5, title: 'Վարկավորման գումար', content: '100,000.00 – 8,000,000.00 ՀՀ դրամ' },
    { id: 6, title: 'Վարկի մարման ժամկետը', content: '60 ամիս' },
    { id: 7, title: 'Տարեկան անվանական տոկոսադրույք', content: '13%' },
    { id: 8, title: 'Տարեկան փաստացի տոկոսադրույք', content: ' 14.08%' },
    { id: 9, title: ' Վարկի գումարը պայմանագրով ամրագրված ժամանակացույցից շուտ մարելու համար վճարվող տուգանք', content: 'Տուգանք չի կիրառվում:' },
    { id: 10, title: 'Վարկի վերադարձելիության ապահովման միջոց', content: 'Առանց անշարժ գույքի գրավադրման, սակայն Բանկի որոշմամբ կարող է պահանջվել երաշխավոր անձ:' },
  ];
    ...
    <div className="min-h-screen bg-gray-50 text-gray-800 font-sans">
      ...
      <section className="bg-purple-50 relative overflow-hidden py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between">
         ...
         <img src="https://www.evoca.am/images-cache/loans/1/16142452651129/560x400.png" alt="" />
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between text-xs text-gray-500">
        ...
        <div className="flex items-center space-x-2 flex-wrap">
          ...
          <span>Վարկեր</span>
          <span>›</span>
          <span className="font-semibold text-gray-700">«ՈՒՍԱՆՈՂԱԿԱՆ» սպառողական վարկ</span>
        </div>
      </div>
          ...
          <div className="lg:col-span-2">
            {activeTab === 'about' && (
              <div className="space-y-5 text-sm text-gray-700 leading-relaxed">
                <p>
                  Մենք կանենք հնարավոր ամեն բան՝ բարձրագույն կրթական համակարգի կարևորությունն ընդգծելու և երիտասարդների համար այն ավելի գրավիչ դարձնելու համար՝ ուղղորդելով նրանց դեպի նոր իրականություն:
                </p>

                <p>
                  Evocabank-ը տրամադրում է ուսանողական <a href="#" className="text-purple-700 font-semibold underline">սպառողական վարկեր ամենաշահավետ ու գրավիչ պայմաններով</a>: Ուսումնառության ողջ ընթացքում վարկառուն կատարում է միայն վարկի տոկոսագումարների մարում (առավելագույնը 5 տարի), իսկ ուսումնառության ավարտից հետո՝ վարկի մայր գումարի և տոկոսագումարների հավասարաչափ մարումներ:
                </p>

                <p>
                  Կարևորելով մեր հաճախորդների ժամանակը՝ մենք հեշտացրել ենք նաև ուսման վարձի վճարման գործընթացը: Ուսումնական հաստատության կողմից տրված և Հաճախորդի կողմից Բանկ ներկայացված հաշիվ-ապրանքագրի հիման վրա գումարն անկանխիկ փոխանցում ենք համապատասխան ուսումնական հաստատության բանկային հաշվին:
                </p>
              </div>
            )}
            ...
            {activeTab === 'documents' && (
              <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm space-y-4">
                <h3 className="font-bold text-gray-800 text-base mb-2">Անհրաժեշտ փաստաթղթեր.</h3>
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 space-y-6 h-fit">
            ...
            <div className="border-b border-gray-100 pb-4 flex justify-between items-center">
              <div>
                ...
                <div className="text-2xl font-black text-purple-800">4 մլն. ֏</div>
              </div>
            ...
            <div className="border-b border-gray-100 pb-4 flex justify-between items-center">
              <div>
                <span className="text-xs text-gray-400 block">մինչև</span>
                <div className="text-2xl font-black text-purple-800">120 ամիս</div>
              </div>
            ...
            <div className="border-b border-gray-100 pb-4 flex justify-between items-center">
              <div>
                <div className="text-2xl font-black text-purple-800">9%</div>
              </div>
            ...
            <div className="flex justify-between items-center">
              <div>
                <div className="text-2xl font-black text-purple-800">2-ից - 3%</div>
              </div>
      ...
      <section className="w-full my-12">
        <div
          ...
          style={{
            backgroundImage: `url('https://www.evoca.am/images-cache/loans/1/1614245265118/1920x527.jpg')`,
          }}
        >
          {/* Overlay */}
