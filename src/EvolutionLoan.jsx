...
const EvolutionLoan = () => {
  ...
  // Պայմանների տվյալներ
  const termsList = [
    { id: 1, title: 'Ովքեր կարող են դիմել', content: '18 տարին լրացած ՀՀ ռեզիդենտները, որոնց տարիքը վարկի սպասարկման ընթացքում չի գերազանցի 63 տարեկանը: Դիմել կարող են նաև ծնողները՝ իրենց երեխաների /շահառու/ համար:' },
    { id: 2, title: 'Վարկի նպատակը', content: 'Ուսումնական և վերապատրաստման դասընթացների, թրեյնինգների ֆինանսավորում' },
    { id: 3, title: 'Վարկավորման արժույթը', content: 'ՀՀ դրամ' },
    { id: 4, title: 'Վարկավորման գումար', content: '100,000.00-1,000,000.00' },
    { id: 5, title: 'Վարկի մարման ժամկետը', content: '12-18 ամիս' },
    { id: 6, title: 'Վարկի տրամադրման եղանակը', content: 'Անկանխիկ' },
     { id: 7, title: 'Համագործակցության վճար գործընկերոջից', content: 'Վարկի գումարի 0-1%՝ միանվագ, կախված համագործակցության պայմաններից' },
      { id: 8, title: 'Վարկունակության գնահատման չափանիշներ', content: 'Պարզեցված՝ համաձայն Ֆիզիկական անձանց անհատական վարկավորման կարգ –ի, առավելագույն OTI - 100%:' },
    
       { id: 9, title: 'Վարկի վերադարձելիության ապահովման միջոց', content: 'Ըստ անհրաժեշտության կարող է պահանջվել Բանկի համար ընդունելի երաշխավորություն' },
        { id: 10, title: 'Կանխավճար', content: 'Ըստ անհրաժեշտության' },
  ];
    ...
    <div className="min-h-screen bg-gray-50 text-gray-800 font-sans">
      ...
      <header className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-12 text-xs font-medium text-gray-600">
            <div className="flex space-x-6">
              <span className="text-purple-700 font-bold cursor-pointer">Անհատ</span>
              <span className="hover:text-purple-700 cursor-pointer">Բիզնես</span>
              <span className="hover:text-purple-700 cursor-pointer">Ակնթարթային վճարումներ</span>
              <span className="hover:text-purple-700 cursor-pointer">Մեր մասին</span>
              <span className="hover:text-purple-700 cursor-pointer">Նորություններ</span>
              <span className="hover:text-purple-700 cursor-pointer">Բլոգ</span>
              <span className="hover:text-purple-700 cursor-pointer">Կարիերա</span>
            </div>
            <div className="flex items-center space-x-4">
              <span className="cursor-pointer hover:text-purple-700">Անցանց հայտեր ▾</span>
              <span className="cursor-pointer hover:text-purple-700">Հետադարձ կապ ▾</span>
        ...
        {/* Main Bank Navigation */}
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex justify-between items-center">
          <div className="flex items-center space-x-8">
            <h1 className="text-2xl font-black tracking-tight text-purple-900 lowercase">
              evoca<span className="text-purple-600">.</span>
            </h1>
            <nav className="flex space-x-6 font-semibold text-sm">
              <a href="#" className="text-purple-700 border-b-2 border-purple-700 pb-1">Վարկեր</a>
              <a href="#" className="hover:text-purple-700">Քարտեր</a>
              <a href="#" className="hover:text-purple-700">Ավանդներ</a>
              <a href="#" className="hover:text-purple-700">Հաշիվներ</a>
              <a href="#" className="hover:text-purple-700">Փոխանցումներ</a>
              <a href="#" className="hover:text-purple-700">Արժեթղթեր</a>
              <a href="#" className="hover:text-purple-700">EvocaSALARY</a>
              <a href="#" className="hover:text-purple-700">EvocaTOUCH</a>
              <a href="#" className="hover:text-purple-700">Evoca codes</a>
            </nav>
          </div>
          <button className="bg-purple-700 text-white px-5 py-2 rounded-lg font-bold text-xs uppercase tracking-wider hover:bg-purple-800 transition">
            EvocaONLINE
          </button>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between">
          <div className="md:w-1/2 z-10 space-y-4">
            ...
            <p className="text-gray-600 text-sm leading-relaxed max-w-lg">
              Նոր որակավորումների և մասնագիտացումների ժամանակն է, բայց ուսման վարձի վճարման խոչընդոտնե՞ր կան, Evocabank-ը կվճարի քո փոխարեն:
            </p>
          </div>

          <div className="md:w-1/2 mt-8 md:mt-0 flex justify-end">
         <img src="	https://www.evoca.am/images-cache/loans/1/16644424027332/560x400.png" alt="" />
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between text-xs text-gray-500">
        ...
        <div className="flex items-center space-x-2 flex-wrap">
          ...
          <span>Վարկեր</span>
          <span>›</span>
          <span className="font-semibold text-gray-700">Evolution</span>
        </div>
      </div>
          ...
          <div className="lg:col-span-2">
            {activeTab === 'about' && (
              <div className="space-y-5 text-sm text-gray-700 leading-relaxed">
                <p>
                  Մենք կանենք հնարավոր ամեն բան, որպեսզի քո կարիերայի ճանապարհը սկսես մեզ հետ:
                </p>

                <p>
                  Անհրաժեշտ է ընտրել ուսումնական հաստատությունը մեր գործընկերների ցանկից, որոնք ի դեպ շուկայում առաջատարներից են, և <strong className="text-purple-700">Evocabank</strong>-ը կֆինանսավորի քո ուսման վճարը <strong className="text-purple-700">ամենաշահավետ ու գրավիչ պայմաններով</strong>:
                </p>

                <p>
                  Կարևորելով մեր հաճախորդների ժամանակը՝ մենք հեշտացրել ենք նաև ուսման վարձի վճարման գործընթացը: Ուսումնական հաստատության կողմից հաստատում ստանալուց հետո՝ ուսման վճարն անկանխիկ փոխանցում ենք համապատասխան ուսումնական հաստատության բանկային հաշվին և քո մասնագիտական ճանապարհորդությունը դեպի հաջողություն սկսված է:
                </p>
              </div>
            )}
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 space-y-6 h-fit">
            ...
            <div className="border-b border-gray-100 pb-4 flex justify-between items-center">
              <div>
                ...
                <div className="text-2xl font-black text-purple-800">1 մլն. ֏</div>
              </div>
            ...
            <div className="border-b border-gray-100 pb-4 flex justify-between items-center">
              <div>
                <span className="text-xs text-gray-400 block">մինչև</span>
                <div className="text-2xl font-black text-purple-800">18 ամիս</div>
              </div>
            ...
            <div className="flex justify-between items-center">
              <div>
                ...
                <div className="text-2xl font-black text-purple-800">18%-ից</div>
              </div>
