...
const MilitaryMortgageLoan = () => {
  const [activeTab, setActiveTab] = useState('about');

  // Պայմանների տվյալներ
  const termsList = [
    { id: 1, title: 'Ովքեր կարող են դիմել', content: '18 – 65 տարեկան Ծրագրի շահառու՝ ՀՀ ՊՆ համակարգի սպայական և ավագ ենթասպայական կազմերի պայմանագրային զինծառայողներ, ՀՀ Ազգային անվտանգության մարմինների և ՀՀ Պետական պահպանության մարմնի ծառայողներ, ում 65 տարեկանը չի բոլորի վարկի սպասարկման ողջ ընթացքում կամ առկա է վերոնշյալ պահանջներին բավարարող շահառուի ընտանիքի անդամ համավարկառու' },
    { id: 2, title: 'Վարկավորման գումար', content: '2,000,000- 25,650,000 ՀՀ դրամ' },
    { id: 3, title: 'Տարեկան անվանական տոկոսադրույքներ', content: '11%' },
    { id: 4, title: 'Պետության կողմից սուբսիդավորվող տոկոսադրույք', content: '5%' },
    { id: 5, title: 'Տարեկան փաստացի տոկոսադրույք', content: '11.9%' },
    { id: 6, title: 'Վարկի մարման ժամկետը', content: '120 - 180 ամիս' },
      { id: 7, title: 'Կանխավճարի և/կամ կառուցապատման գծով աջակցության չափ', content: '2,500,000 ՀՀ դրամ` միանվագՎարկի մարման ձևը' },
        { id: 8, title: 'Վարկի մարման ձևը', content: 'Ամսական անուիտետային' },
           { id: 9, title: 'Վարկի վերադարձելիության ապահովման միջոց', content: 'Ձեռք բերվող անշարժ գույքը/գնման իրավունքը: Կառուցապատման դեպքում հողամասը/կիսակառույցը որտեղ իրականացվում է անշարժ գույքի  կառուցումը, անհրաժեշտության դեպքում` լրացուցիչ բնակելի անշարժ գույք:' },
      { id: 10, title: 'Անշարժ գույքի ձեռքբերման և գնահատված շուկայական առավելագույն արժեքը', content: '55,000,000 ՀՀ դրամ /միայն անշարժ գույքի ձեռքբերման դեպքում/' },
        ];
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-800 font-sans">
      ...
      <section className="bg-purple-50 relative overflow-hidden py-10">
        ...
        <img src="	https://www.evoca.am/images-cache/loans/1/17129179540427/560x400.png" alt="" />
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between text-xs text-gray-500">
        ...
        <div className="flex items-center space-x-2 flex-wrap">
          ...
          <span>Վարկեր</span>
          <span>›</span>
          <span className="font-semibold text-gray-700">Հիփոթեքային վարկեր Զինծառայողներին</span>
        </div>
      </div>
          ...
          <div className="lg:col-span-2">
            {activeTab === 'about' && (
              <div className="space-y-5 text-sm text-gray-700 leading-relaxed">
                <p>
                  Փնտրո՞ւմ ես հարմար բնակարան: Evocabank-ի նոր հիփոթեքային վարկի միջոցով կարող ես ձեռք բերել այն ինչպես կառուցապատողից, այնպես էլ երկրորդային շուկայից:
                </p>

                <p>
                  «Հիփոթեքային վարկեր Զինծառայողներին» վարկատեսակը տրամադրվում է սպայական և ավագ ենթասպայական կազմերի պայմանագրային զինծառայողներին պետական նպատակային ծրագրի շրջանակում անմիջապես կառուցապատողից, ինչպես նաև երկրորդային շուկայից բնակելի նշանակության անշարժ գույքի՝ բնակարանի կամ անհատական բնակելի տան ձեռքբերման կամ բնակելի տան կառուցապատման նպատակով:
                </p>

                <p>
                  Ծրագրի շրջանակում զինծառայողները հնարավորություն ունեն ստանալ պետական աջակցություն կանխավճարի և տոկոսագումարների սուբսիդավորման տեսքով:
                </p>
              </div>
            )}
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 space-y-6 h-fit">
            ...
            <div className="border-b border-gray-100 pb-4 flex justify-between items-center">
              <div>
                ...
                <div className="text-2xl font-black text-purple-800">25,65 մլն. ֏</div>
              </div>
            ...
            <div className="border-b border-gray-100 pb-4 flex justify-between items-center">
              <div>
                <div className="text-2xl font-black text-purple-800">120-240 ամիս</div>
              </div>
              <span className="text-xs text-gray-600 font-semibold">Մարման ժամկետ</span>
            </div>

            <div className="border-b border-gray-100 pb-4 flex justify-between items-center">
              <div>
                <div className="text-2xl font-black text-purple-800">11% - 12.75%</div>
              </div>
              <span className="text-xs text-gray-600 font-semibold text-right">Տարեկան անվանական տոկոսադրույք</span>
            </div>

            <div className="flex justify-between items-center">
              <div>
                <div className="text-2xl font-black text-purple-800">5%</div>
              </div>
              <span className="text-xs text-gray-600 font-semibold text-right">Սուբսիդավորվող տոկոսադրույք</span>
            </div>
          </div>
        </div>
      </main>
...
export default MilitaryMortgageLoan;