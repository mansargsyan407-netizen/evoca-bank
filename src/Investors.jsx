...
const Investors = () => {
  const [activeSubTab, setActiveSubTab] = useState('investors');
  ...
  // Նկարներում պատկերված տվյալների կառուցվածքը
  const investorData = [
    {
      year: 2026,
      quarters: [
        { label: 'Q1 2026', code: '2026 Q1' },
    ...
    },
    {
      year: 2025,
      quarters: [
        { label: 'Q1 2025', code: '2025 Q1' },
        { label: 'Q2 2025', code: '2025 Q2' },
        { label: 'Q3 2025', code: '2025 Q3' },
        { label: 'Q4 2025', code: '2025 Q4' },
      ],
    },
    {
      year: 2024,
      quarters: [
        { label: 'Q1 2024', code: '2024 Q1' },
        { label: 'Q2 2024', code: '2024 Q2' },
        { label: 'Q3 2024', code: '2024 Q3' },
        { label: 'Q4 2024', code: '2024 Q4' },
      ],
    },
    {
      year: 2023,
      quarters: [
        { label: 'Q1 2023', code: '2023 Q1' },
        { label: 'Q2 2023', code: '2023 Q2' },
        { label: 'Q3 2023', code: '2023 Q3' },
        { label: 'Q4 2023', code: '2023 Q4' },
      ],
    },
  ];
    ...
    <div className="bg-white min-h-screen text-gray-800 font-sans pb-16">
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8 pt-6">
        <div className="text-xs text-gray-500 mb-6 flex items-center space-x-2">
          ...
          <span>›</span>
          <span className="text-gray-800 font-medium">Ներդրողների համար</span>
        </div>
      ...
      {/* Ներդրողների շնորհանդեսների բաժինը */}
      <div className="max-w-6xl mx-auto px-4 md:px-8 space-y-10">
        {investorData.map((section) => (
          <div key={section.year} className="space-y-4">
            <h2 className="text-xl font-extrabold text-gray-900">{section.year}</h2>

            {/* Մոխրագույն ֆոնով քարտերի բլոկը */}
            <div className="bg-[#f7f5fb] rounded-xl p-6">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                {section.quarters.map((q, idx) => (
                  <div key={idx} className="flex flex-col space-y-2 group cursor-pointer">
                    {/* Քարտի դիզայնը */}
                    <div className="relative aspect-square bg-gradient-to-br from-purple-800 via-purple-600 to-indigo-900 rounded-lg p-4 flex flex-col justify-between text-white shadow-md hover:shadow-xl transition-transform transform group-hover:-translate-y-1 overflow-hidden">
                      <div className="flex justify-between items-start text-[10px] md:text-xs font-semibold opacity-90">
                      ...
                      <div className="text-2xl md:text-3xl font-black tracking-tight mt-auto">
                        evoca
                      </div>
                    </div>

                    {/* Քարտի տակի տեքստը */}
                    <span className="text-xs font-bold text-gray-700 group-hover:text-purple-700 transition">
                      {q.label}
                    </span>
                  </div>
                ))}
