...
export default function MitCertifiedPage() {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <p className="text-base font-semibold text-gray-600 leading-relaxed">
              Evocabank-ը տարածաշրջանում առաջին ընկերությունն է, որի ղեկավարները հաջողությամբ ավարտել են MIT-ի Generative AI դասընթացը:
            </p>

            <p className="text-xs text-gray-400">17.07.2026</p>

            <hr className="border-gray-100 my-6" />

            <div className="space-y-4 text-sm text-gray-700 leading-relaxed">
              <p>
                <strong className="text-[#6b21a8]">Evocabank</strong>-ի ավելի քան <strong className="text-gray-900">70 ղեկավար</strong> մասնակցեց և հաջողությամբ ավարտեց <strong className="text-gray-900">Massachusetts Institute of Technology (MIT) Open Learning</strong>-ի երեքշաբաթյա <strong className="text-gray-900">"Understanding and Using Generative AI" դասընթացը</strong>:
              </p>

              <p>
                Օնլայն դասընթացներին զուգահեռ ծրագիրը ներառում էր նաև real-time վիդեո հանդիպումներ, որոնց ընթացքում MIT Open Learning-ի AI Education & Innovation-ի ղեկավար <strong className="text-gray-900">Dr. David Dixon</strong>-ը ներկայացնում էր Generative AI-ի կիրառման գործնական հնարավորություններն ու ազդեցությունը բիզնեսի վրա, ինչպես նաև քննարկվում էին Բանկի թիմի կողմից բարձրացված հարցերը:
              </p>

              {/* Executives Photo inside text area */}
              <div className="my-6 rounded-2xl overflow-hidden shadow-md border border-gray-100">
                <img 
                  src="https://www.evoca.am/file_manager/IMG_0069.PNG" 
                  alt="Evocabank Executives MIT Online Session" 
                  className="w-full h-auto object-cover"
                />
              </div>

              <blockquote className="italic border-l-4 border-[#6b21a8] pl-4 py-2 my-4 text-gray-600 bg-purple-50/50 rounded-r-lg">
                «Evocabank-ում միշտ բարձր է գնահատվել շարունակական զարգացումն ու ինքնակրթությունը, իսկ արհեստական բանականության հմտություններ սովորելն այսօրվա, ես կասեի անգամ երեկվա պահանջն է: Սա մեր թիմի՝ նոր հմտություններով վերազինման սկիզբն է: Պետք է այնպես անենք, որ AI-ը դառնա մեր թիմի superpower-ը»,- նշել է <strong className="text-gray-900">Evocabank-ի Վարչության Նախագահ Կարեն Եղիազարյանը</strong>:
              </blockquote>

              <p>
                Ի դեպ, Բանկի ամբողջ թիմն ամիսներ առաջ մասնակցեց <strong className="text-gray-900">«AI գրագիտության դասընթաց Evocabank-ի համար» 14-ժամյա ծրագրին</strong>, որը հատուկ Բանկի աշխատակիցների համար մշակվել էր <strong className="text-gray-900">reArmenia ակադեմիայի</strong> կողմից: Evoca-ում նաև խրախուսվում են նեղ մասնագիտական AI դասընթացներն ու թրեյնինգները:
              </p>
            </div>
          </div>
          ...
          <div className="lg:col-span-6 sticky top-8">
            <div className="rounded-3xl overflow-hidden shadow-lg border border-gray-100">
              <img 
                ...
                alt="MIT Certified Evocabank Executives" 
                className="w-full h-auto object-cover"
              />
            </div>
          </div>
