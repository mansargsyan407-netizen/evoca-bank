    ...
    <div className="min-h-screen bg-gray-50 text-gray-800 font-sans">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between">
          <div className="md:w-1/2 z-10 space-y-4">
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 leading-tight">
              ԱԶԸ-ի ծրագրով վերանորոգման վարկեր
            </h2>
          ...
          <div className="md:w-1/2 mt-8 md:mt-0 flex justify-end">
           <img src="https://www.evoca.am/images-cache/loans/1/16142533830759/560x400.png" alt="" />
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between text-xs text-gray-500">
        ...
        <div className="flex items-center space-x-2">
          ...
          <span>Վարկեր</span>
          <span>›</span>
          <span className="font-semibold text-gray-700">ԱԶԸ-ի ծրագրով վերանորոգման վարկեր</span>
        </div>
      </div>
          ...
          <div className="lg:col-span-2">
            {activeTab === 'about' && (
              <div className="space-y-5 text-sm text-gray-700 leading-relaxed">
                <p>
                  <strong className="text-purple-700">Evocabank</strong>-ն առաջարկում է բնակելի անշարժ գույքի վերանորոգման վարկեր՝ բնակարանային պայմանների բարելավման նպատակով Ազգային Հիփոթեքային Ընկերության ծրագրի շրջանակներում:
                </p>
                <p>
                  Օգտվելով վարկատեսակից՝ դու <strong className="text-purple-700 border-b border-purple-700 pb-0.5">վերանորոգում ես քո տունն</strong> ու <strong className="text-purple-700 border-b border-purple-700 pb-0.5">նվազեցնում կոմունալ ծախսերը</strong>, ունենում խնայողություններ՝ նպաստելով բնակարանի շուկայական արժեքի բարձրացմանը:
                </p>
                <p>
                  Ընտրելով Evocabank-ը՝ կխնայես քո գումարն ու ժամանակը: Վարկի ձևակերպման համար անհրաժեշտ փաստաթղթերը ներկայացնելուց հետո Evocabank-ը վարկի տրամադրման որոշումը կկայացնի ամենասեղմ ժամկետներում:
                </p>
              </div>
            )}
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 space-y-6 h-fit">
            ...
            <div className="border-b border-gray-100 pb-4 flex justify-between items-center">
              <div>
                ...
                <div className="text-2xl font-black text-purple-800">15 մլն. ֏</div>
              </div>
            ...
            <div className="border-b border-gray-100 pb-4 flex justify-between items-center">
              <div>
                <span className="text-xs text-gray-400 block">մինչև</span>
                <div className="text-2xl font-black text-purple-800">84 ամիս</div>
              </div>
            ...
            <div className="flex justify-between items-center">
              <div>
                ...
                <div className="text-2xl font-black text-purple-800">12.5%-ից</div>
              </div>
      ...
      <section className="w-full my-12">
        <div
          ...
          style={{
            backgroundImage: `url('https://www.evoca.am/images-cache/loans/1/16142533830791/1920x527.jpg')`,
          }}
        >
          ...
          <div className="text-center text-white px-4 max-w-3xl z-10 space-y-2">
            <h3 className="text-2xl sm:text-3xl md:text-4xl font-extrabold drop-shadow-md leading-tight">
              Վերանորոգիր քո բնակարանը նորաձևության վերջին ստանդարտներին համապատասխան և բարելավիր քո կենսապայմանները։
            </h3>
          </div>
        </div>
      </section>
...
export default NmcRenovationLoan;