...
export default function ProductivityLoanPage() {
        ...
        <div className="max-w-7xl mx-auto px-6 py-12 md:py-16 grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
          ...
          <div className="md:col-span-7 space-y-4 z-10">
            ...
            <p className="text-gray-600 text-sm md:text-base leading-relaxed max-w-2xl">
              Մատչելի ֆինանսավորում Ձեր բիզնեսը արդիականացնելու և արտադրողականությունը խթանելու նպատակով:
            </p>
          </div>

          {/* Right Graphic */}
          <div className="md:col-span-5 flex justify-center relative">
           <img src="	https://www.evoca.am/images-cache/loans/1/1614869606836/560x400.png" alt="" />
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start mb-12">
          ...
          <div className="lg:col-span-7 space-y-4 text-gray-700 text-sm md:text-base leading-relaxed">
            {activeTab === 'about' && (
              <>
                <p>
                  Վարկից կարող են օգտվել ՀՀ տարածքում գրանցված և փաստացի գործունեություն իրականացնող առևտրային և ոչ առևտրային կազմակերպությունները կամ անհատ ձեռնարկատերերը:
                </p>

                <p className="font-bold text-gray-900 pt-2">
                  Տրամադրվող միջոցները կարող են օգտագործվել՝
                </p>
                ...
                <ul className="space-y-3 pl-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Նոր մեքենասարքավորումների և տվյալ մեքենասարքավորումների բաղկացուցիչ մասերի գնման կամ ներմուծման նպատակով:
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-purple-700 font-bold text-lg leading-none">&bull;</span>
                    <span>
                      Նշված մեքենասարքավորումների մոնտաժման և սպասարկման համար կապիտալ շինարարության իրականացման նպատակով:
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-purple-700 font-bold text-lg leading-none">&bull;</span>
                    <span>
                      Բիզնես գործընթացների թվայնացման նպատակով թվային ծրագրերի կամ հարթակների ձեռքբերման համար:
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-purple-700 font-bold text-lg leading-none">&bull;</span>
                    <span>
                      Արտադրողականության բարձրացման նպատակով խորհրդատվական ծառայությունների և փորձագետների ներգրավման համար:
                    </span>
                  </li>
                </ul>
          ...
          <div className="lg:col-span-5 bg-white border border-purple-100 rounded-2xl p-6 shadow-xl shadow-purple-500/5 space-y-6">
            ...
            <div className="space-y-5 divide-y divide-gray-100">
              ...
              <div className="flex items-baseline justify-between pt-2">
                ...
                <div className="text-xs font-semibold text-gray-500 text-right max-w-[160px]">
                  Կամ համարժեք արտարժույթ սահմանաչափ
                </div>
              </div>
