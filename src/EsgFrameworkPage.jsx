...
export default function EsgFrameworkPage() {
  return (
      ...
      <div>
        ...
        <div className="max-w-7xl mx-auto px-6 pt-6 pb-4">
          ...
          <div className="text-[11px] text-gray-400 flex items-center gap-1.5 mb-6">
            ...
            <span>›</span>
            <span className="text-gray-600 font-medium truncate max-w-[200px]">ESG կառավարման համակարգը Evocabank-ում</span>
          </div>
        </div>
            ...
            <div className="lg:col-span-6 p-8 lg:p-14 flex flex-col justify-between space-y-6">
              <div className="space-y-4">
                ...
                <p className="text-xs md:text-sm text-gray-600 leading-relaxed">
                  Evocabank-ը ներդրել է ESG կառավարման համակարգ՝ ամրապնդելով բնապահպանական և սոցիալական ռիսկերի կառավարման գործընթացները։
                </p>
              </div>
              <p className="text-xs text-gray-400 font-medium">31.03.2026</p>
            </div>

            {/* Right side image / banner graphic */}
            <div className="lg:col-span-6 bg-[#8b5cf6] relative min-h-[300px] flex items-center justify-center overflow-hidden p-6">
           <img src="https://www.evoca.am/images-cache/news/1/17757342882486/780x585.png" alt="" />
            </div>
          </div>
        </section>
        ...
        <main className="max-w-4xl mx-auto px-6 pb-20 relative">
          ...
          <div className="space-y-6 text-sm md:text-base text-gray-700 leading-relaxed">
            <p>
              <strong className="text-purple-900 font-bold">Evocabank</strong>-ը կարևորում է բնապահպանական և սոցիալական սկզբունքների ներդրումը՝ դրանք դիտարկելով որպես պատասխանատու և կայուն բանկային գործունեության կարևոր գործոն։ Այն նպատակով Բանկի Խորհրդի կողմից ընդունվել են մի շարք կարևոր որոշումներ՝ ուղղված <strong className="text-gray-900">ESG (Environmental, Social, Governance)</strong> սկզբունքների ներդրմանը և բնապահպանական ու սոցիալական ռիսկերի կառավարման գործընթացների ամրապնդմանը։
            </p>

            <p>
              Բանկի Խորհրդի անդամ <strong className="text-gray-900 font-bold">Տաթևիկ Ջանոյանը</strong> նշանակվել է <strong className="text-gray-900">ESG համակարգող</strong>՝ ESG սկզբունքների ներդրումը Բանկում ապահովելու, ինչպես նաև բնապահպանական ու սոցիալական ռիսկերի կառավարման գործընթացներն արդյունավետ համակարգելու նպատակով։
            </p>

            <p>
              Բանկի Վարչության կողմից վերահաստատվել ու հրապարակվել է <strong className="text-gray-900 font-bold">Բնապահպանական և սոցիալական կառավարման համակարգը (ԲՍԿՀ)</strong>, որը սահմանում է բնապահպանական ու սոցիալական ռիսկերի կառավարման հիմնական սկզբունքներն ու մեխանիզմները։ Բանկի կողմից սահմանված ԲՍԿՀ-ին կարող եք ծանոթանալ <a href="#" className="text-purple-700 font-semibold underline hover:text-purple-900 transition">այստեղ</a>։
            </p>

            <p>
              Այս նախաձեռնություններն ևս մեկ քայլ են <strong className="text-purple-900 font-bold">Evocabank</strong>-ի կողմից՝ պատասխանատու բանկային գործունեության և կայուն զարգացման սկզբունքների ամրապնդման ուղղությամբ։
            </p>
          </div>
        </main>
      </div>
