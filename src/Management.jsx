...
const Management = () => {
  ...
  const boardOfDirectors = [
    ...
    },
    {
      ...
      position: 'Խորհրդի անդամ, Ռիսկերի և համապատասխանության կոմիտեի նախագահ, Ռազմավարության կոմիտեի անդամ',
      image: 'https://www.evoca.am/images-cache/team_members/1/1675080847328/230x230.png',
    },
    {
      name: 'ՊԻԵՐ ԿԱԶԻՉԱԿ, MBA',
      position: 'Խորհրդի անդամ, Ռիսկերի և համապատասխանության կոմիտեի անդամ, Ռազմավարության կոմիտեի անդամ',
      image: 'https://www.evoca.am/images-cache/team_members/1/17544805424545/230x230.png',
    },
    {
      name: 'ԱՐԿԱԴԻ ՍԱՆԴԼԵՐ',
      position: 'Խորհրդի անդամ',
      image: 'https://www.evoca.am/images-cache/team_members/1/17884208691388/230x230.png',
    },
  ];
  ...
  const internalAudit = [
    {
      name: 'ՆԱԶԵԼԻ ԵՂՈՅԱՆ, CIA',
      position: 'Ներքին աուդիտի ստորաբաժանման ղեկավար',
  ...
  return (
    <div className="bg-white min-h-screen text-gray-800">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-8">
        <h1 className="text-2xl md:text-3xl font-bold text-center mb-10 text-slate-800">
          Ղեկավարություն
        </h1>

        {/* 1. Բանկի խորհուրդ */}
        <section className="mb-14">
          <h2 className="text-lg md:text-xl font-bold text-gray-800 mb-8 border-b pb-2">
            Բանկի խորհուրդ
          </h2>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
            {boardOfDirectors.map((member, idx) => (
              <div key={idx} className="flex flex-col items-center text-center">
                <div className="bg-gray-100 rounded-t-full pt-4 px-2 mb-3 w-full max-w-[200px] flex justify-center">
                  <img
                    src={member.image}
                    alt={member.name}
        ...
        {/* 3. Բանկի ներքին աուդիտ */}
        <section className="mb-14">
          <h2 className="text-lg md:text-xl font-bold text-gray-800 mb-8 border-b pb-2">
            Բանկի ներքին աուդիտ
          </h2>
          <div className="flex justify-start">
            {internalAudit.map((member, idx) => (
              <div key={idx} className="flex flex-col items-center text-center w-full max-w-[220px]">
                <div className="bg-gray-100 rounded-t-full pt-4 px-2 mb-3 w-full flex justify-center">
                  <img
                    src={member.image}
                    alt={member.name}
                    className="w-full h-auto object-cover rounded-b-lg"
