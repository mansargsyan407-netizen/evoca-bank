...
export default function EvocaGoPage() {
              ...
              <>
                <div>
                  <p className="font-semibold text-gray-800 mb-3">
                    <span className="text-purple-700 font-bold">ԵՆԲ</span> կողմից ֆինանսավորվող ծրագրի շրջանակներում վարկառուներ կարող են հանդիսանալ Հայաստանի ռեզիդենտ իրավաբանական և անհատ ձեռնարկատեր անձինք`
                  </p>
                  <ol className="list-decimal pl-5 space-y-2 text-gray-700 font-medium">
                    <li>
                      <span className="font-bold">ՓՄՁ-ներ</span> (աշխատակիցների քանակը չպետք է գերազանցի 250-ը)։
                    </li>
                    <li>
                      <span className="font-bold">Միջին կապիտալիզացիայի կազմակերպություններ</span> (աշխատակիցների քանակը 250-ից 3000)։
                    </li>
                  </ol>
                </div>
                ...
                <div className="space-y-3 pt-2">
                  ...
                  <ul className="space-y-2 text-gray-700 pl-2">
                    ...
                    <li className="flex items-center gap-2">
                      <span className="w-2 h-2 rounded-full bg-purple-700 shrink-0"></span>
                      Հիմնական միջոցների ձեռքբերում և/կամ
                    </li>
                    <li className="flex items-center gap-2">
                      <span className="w-2 h-2 rounded-full bg-purple-700 shrink-0"></span>
                    ...
                    <li className="flex items-start gap-2">
                      <span className="w-2 h-2 rounded-full bg-purple-700 shrink-0 mt-2"></span>
                ...
                <div className="space-y-3 pt-2">
                  <p className="font-semibold text-gray-800">
                    Վերը նշված ոլորտների թիրախային ուղղություններն են`
                  </p>
                  <ul className="space-y-2 text-gray-700 pl-2">
                    <li className="flex items-center gap-2">
                      <span className="w-2 h-2 rounded-full bg-purple-700 shrink-0"></span>
                      Էներգաարդյունավետության բարձրացման խթանում,
                    </li>
                    <li className="flex items-center gap-2">
                      <span className="w-2 h-2 rounded-full bg-purple-700 shrink-0"></span>
                      Կանանց ձեռներեցության խթանում,
                    </li>
                    <li className="flex items-center gap-2">
                      <span className="w-2 h-2 rounded-full bg-purple-700 shrink-0"></span>
                    ...
                    <li className="flex items-center gap-2">
                      <span className="w-2 h-2 rounded-full bg-purple-700 shrink-0"></span>
                      Թվայնացման ու ավտոմատացման խթանում:
                    </li>
                  </ul>
                </div>

                <p className="pt-2 text-gray-600 text-xs md:text-sm">
          ...
          <div className="lg:col-span-5 bg-white border border-purple-100 rounded-2xl p-6 shadow-xl shadow-purple-500/5 space-y-6">
            ...
            <div className="space-y-5 divide-y divide-gray-100">
              ...
              <div className="flex items-baseline justify-between pt-4">
                ...
                <div className="text-xs font-semibold text-gray-500 text-right max-w-[140px]">
                  Մայր գումարի արտոնյալ ժամկետ (ոչ պարտադիր)
                </div>
              </div>
