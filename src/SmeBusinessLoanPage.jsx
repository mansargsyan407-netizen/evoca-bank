...
export default function SmeBusinessLoanPage() {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          <div className="lg:col-span-7 space-y-6 text-gray-700 text-sm md:text-base leading-relaxed">
            {activeTab === 'about' && (
              <>
                <p>
                  Evocabank-ը առաջարկում է Բիզնես վարկեր Հայաստանի ռեզիդենտ և ոչ ռեզիդենտ իրավաբանական անձանց և անհատ ձեռնարկատերերի համար՝ բիզնեսի զարգացման, կապիտալ ներդրումների իրականացման, շրջանառու կապիտալի համալրման և այլ նպատակներով:
                </p>
                <p>
                  <span className="font-bold text-purple-700">Վարկի</span> համար կարող են դիմել արդյունաբերության, շինարարության, առևտրի, տրանսպորտի և կապի, գյուղատնտեսության և այլ ոլորտներում գործունեություն ծավալող կազմակերպությունները: Վարկերը կարող են տրամադրվել միանվագ կամ փուլային եղանակով, ինչպես նաև, կախված գործունեության ոլորտից, կարող են ունենալ մարման արտոնյալ ժամանակաշրջան:
                </p>
                <p>
            ...
            {activeTab === 'terms' && (
              <div className="p-4 bg-gray-50 rounded-xl border border-gray-100">
                <h3 className="font-bold text-purple-900 mb-2">Մանրամասն պայմաններ</h3>
                <p className="text-sm text-gray-600">
                  Վարկի տոկոսադրույքները և ժամկետները կախված են բիզնեսի տեսակից, գրավի առարկայից և ֆինանսական ցուցանիշներից:
                </p>
              </div>
            )}
            ...
            {activeTab === 'docs' && (
              <div className="p-4 bg-gray-50 rounded-xl border border-gray-100">
                <h3 className="font-bold text-purple-900 mb-2">Անհրաժեշտ փաստաթղթեր</h3>
                <ul className="list-disc pl-5 text-sm space-y-1 text-gray-600">
                  <li>Իրավաբանական անձի պետական ռեգիստրի վկայական</li>
                  <li>Կանոնադրություն և ՀՎՀՀ</li>
                  <li>Ֆինանսական հաշվետվություններ</li>
                  <li>Գրավադրվող գույքի սեփականության վկայական</li>
                </ul>
              </div>
            )}
          </div>
