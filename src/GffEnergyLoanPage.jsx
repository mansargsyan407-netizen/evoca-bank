...
export default function GffEnergyLoanPage() {
        ...
        <div className="max-w-7xl mx-auto px-6 py-12 md:py-16 grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
          ...
          <div className="md:col-span-7 space-y-4 z-10">
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-black leading-tight tracking-tight">
              Վարկեր ԳՀՀ - Էներգաարդյունավետություն ՓՄՁ-ների համար ծրագիր
            </h1>
            <p className="text-purple-100 text-sm md:text-base leading-relaxed max-w-2xl opacity-90">
              Եթե Դուք ցանկանում եք ձեռք բերել ԷԱ սարքավորումներ և մեքենաներ կամ իրականացնել այլ Էներգաարդյունավետ ներդրումներ, այս վարկատեսակը Ձեզ համար է։
            </p>
          </div>
              ...
              <>
                ...
                <div className="space-y-3 pt-2">
                  ...
                  <p className="text-gray-700 font-semibold">
                    <span className="underline text-purple-800">Էներգաարդյունավետ</span> սարքավորումների և մեքենաների ձեռքբերում, ենթակառուցվածքների կառուցում և այլ նախագծեր, որոնք օգտագործում են վերականգնվող էներգիայի աղբյուրներ`
                  </p>
