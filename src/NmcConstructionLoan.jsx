    ...
    <div className="min-h-screen bg-gray-50 text-gray-800 font-sans">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between">
          <div className="md:w-1/2 z-10 space-y-4">
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 leading-tight">
              ԱԶԸ-ի ծրագրով կառուցապատման վարկեր
            </h2>
            <p className="text-gray-600 text-sm leading-relaxed max-w-lg">
              Կատարիր ներդրում քո բնակարանի էներգաարդյունավետ կառուցապատման մեջ և ստացիր հնարավորություն վճարել ավելի քիչ ծախսված էլեկտրաէներգիայի և գազի համար:
            </p>
          </div>

          <div className="md:w-1/2 mt-8 md:mt-0 flex justify-end">
         <img src="https://www.evoca.am/images-cache/loans/1/17265524369773/560x400.png" alt="" />
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between text-xs text-gray-500">
        ...
        <div className="flex items-center space-x-2">
          ...
          <span>Վարկեր</span>
          <span>›</span>
          <span className="font-semibold text-gray-700">ԱԶԸ-ի ծրագրով կառուցապատման վարկեր</span>
        </div>
      </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            {activeTab === 'about' && (
              <div className="space-y-5 text-sm text-gray-700 leading-relaxed">
                <p>
                  Վարկատեսակը նախատեսված է Ազգային հիփոթեքային ընկերության կառուցապատման ծրագրի ներքո՝ սահմանված չափանիշներին բավարարող բնակելի տան կառուցման համար:
                </p>
                <p>
                  Վարկի առավելագույն գումարը կարող է կազմել քո կողմից ներկայացված կառուցման աշխատանքների կատարման նախահաշվի գումարի <strong>80%</strong>-ը: Հիփոթեքային վարկը տրամադրվում է մասնաբաժիններով (տրանշերով), ընդ որում, վարկի վերջին մասնաբաժնով պետք է ֆինանսավորվի շինարարական աշխատանքների վերջին փուլը և չպետք է գերազանցի վարկի գումարի <strong>20%</strong>-ը:
                </p>
                <p>
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 space-y-6 h-fit">
            ...
            <div className="border-b border-gray-100 pb-4 flex justify-between items-center">
              <div>
                <span className="text-xs text-gray-400 block">առավելագույնը</span>
                <div className="text-2xl font-black text-purple-800">240 ամիս</div>
              </div>
              <span className="text-xs text-gray-600 font-semibold">Վարկի մարման ժամկետ</span>
            </div>

            <div className="flex justify-between items-center">
              <div>
                <span className="text-xs text-gray-400 block">սկսած</span>
                <div className="text-2xl font-black text-purple-800">12.5%</div>
              </div>
...
export default NmcConstructionLoan;