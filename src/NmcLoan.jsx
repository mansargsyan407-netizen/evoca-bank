...
const NmcLoan = () => {
  ...
  // Պայմանների տվյալներ
  const termsList = [
    { id: 1, title: 'Վարկի տրամադրման նպատակը', content: 'Կառուցվող կամ գոյություն ունեցող բնակելի անշարժ գույքի ձեռքբերում բնակության նպատակով:' },
    { id: 2, title: 'Ովքեր կարող են դիմել', content: '18–65 տարեկան ՀՀ քաղաքացի հանդիսացող ֆիզիկական անձինք, որոնց եկամուտների հիմնական աղբյուրը գտնվում է ՀՀ-ում և ովքեր վարկի սպասարկման ողջ ընթացքում չեն բոլորի 65 տարեկանը կամ առկա է վերոնշյալ պահանջներին բավարարող համավարկառու:' },
    { id: 3, title: 'Տեսակները', content: 'Ձեռքբերման ստանդարտ վարկեր.Ձեռքբերման Կանաչ վարկեր' },
    { id: 4, title: 'Վարկավորման արժույթը', content: 'ՀՀ դրամ' },
    { id: 5, title: 'Վարկավորման գումար', content: '2,000,000- 35,000,000 ՀՀ դրամ 2,000,000-  45,000,000 ՀՀ դրամ' },
    { id: 6, title: 'Վարկի մարման ժամկետը', content: '120 –  240 ամիս' },
     { id: 7, title: 'Վարկի գումարը պայմանագրով ամրագրված ժամանակացույցից շուտ մարելու համար վճարվող տուգանք', content: 'Տուգանք չի կիրառվում' },
     { id: 8, title: 'Վարկի գումարների և տոկոսագումարների մարման ժամկետների ուշացման դեպքում վճարվող տույժեր', content: 'ժամկետանց վարկի համար՝ օրական 0.015%,ժամկետանց տոկոսագումարի համար օրական 0.1%:' },
   { id: 9, title: 'Վարկի մարման ձևը', content: 'Անուիտետային կամ մայր գումարի հավասարաչափ մարումներով վարկ. վճարումները պետք է կատարվեն ամսական կտրվածքով։' },
   { id: 10, title: 'Վարկի վերադարձելիության ապահովման միջոց', content: 'Գոյություն ունեցող բնակելի անշարժ գույքի ձեռք բերման նպատակով տրամադրված վարկերի դեպքում գրավադրվում է ձեռքբերվող բնակելի անշարժ գույքը, իսկ կառուցվող բնակելի անշարժ գույքի ձեռք բերման նպատակով տրամադրված վարկերի դեպքում վարկի ապահովթւուն է հանդիսանում կառուցվող բնակելի անշարժ գույքի գնման իրավունքի և կառուցապատողի հատուկ հաշվին առկա դրամական միջոցների գրավը, մինչև անշարժ գույքի նկատմամբ սեփականության իրավունքի գրանցումը, որից հետո գրավ է հանդիսանում անշարժ գույքը' },
   { id: 1, title: '', content: '[1] Վարկ/գրավ գործակցի հաշվարկման ժամանակ ընդունվում է անշարժ գույքի գնահատման և ձեռքբերման արժեքներից նվազագույնը:' },
   { id: 2, title: '', content: '[2] Գույքի ձեռքբերման գնի և վարկի գումարի տարբերության չափով:' },
  ...
  const documentsList = [
    'Վարկի տրամադրման դիմում-հայտ անձնագիր կամ նույնականացման քարտ ինչպես նաև, սոցիալական քարտ կամ սոցիալական քարտ չունենալու մասին տեղեկանք (ընդ որում սոցիալական քարտ և սոցիալական քարտ չունենալու մասին տեղեկանք չի պահանջվում, եթե ներկայացվել է նույնականացման քարտ), ամուսնության վկայական (առկայության դեպքում),անչափահաս երեխաների ծննդյան վկայական (առկայության դեպքում),տեղեկանք աշխատանքի վայրից աշխատավարձի չափի մեծության մասին, որի տրամադրման ժամկետը Բանկին ներկայացման օրվա դրությամբ չպետք է գերազանցի 30 օրացույցային օրը,անհատական հաշվի քաղված Հաճախորդի ինքնազբաղված լինելու դեպքում`Հարկ վճարողի հարկային համարը (ՀՎՀՀ)Գրանցման վկայական, կանոնադրություն (առկայության դեպքում)Գործունեության տվյալ տեսակով զբաղվելու թույլտվության փաստաթղթերը, եթե օրենսդրության համաձայն տվյալ գործունեության համար անհրաժեշտ է համապատասխան մարմինների կողմից հատուկ թույլտվություն Վերջին 1 տարվա ֆինանսական և հարկային հաշվետվությունները` հաստատված հարկային մարմինների կողմիցՎերջին 6 ամիսների եկամուտների և ծախսերի հաշվետվությունները/գրառումները (առկայության դեպքում)ձեռք բերվող անշարժ գույքի գնահատման հաշվետվություն,վաճառվող գույքի սեփականության վկայականը,վաճառվող անշարժ գույքի ձեռք բերման հիմքերը,անշարժ գույքի սեփականատերերի անձնագրերը,տեղեկատվություն՝ երաշխավորող անձի/անց վերաբերյալ (պահանջի դեպքում),անհրաժեշտության դեպքում կարող են պահանջվել նաև այլ փաստաթղթեր',
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-800 font-sans">
      ...
      {/* Hero Banner Section */}
      <section className="bg-purple-50 relative overflow-hidden py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between">
          <div className="md:w-1/2 z-10 space-y-4">
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 leading-tight">
              ԱԶԸ-ի ծրագրով ձեռք բերման վարկեր
            </h2>
          ...
          <div className="md:w-1/2 mt-8 md:mt-0 flex justify-end">
           <img src="	https://www.evoca.am/images-cache/loans/1/16142450957037/560x400.png" alt="" />
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between text-xs text-gray-500">
        ...
        <div className="flex items-center space-x-2">
          ...
          <span>Վարկեր</span>
          <span>›</span>
          <span className="font-semibold text-gray-700">ԱԶԸ-ի ծրագրով ձեռք բերման վարկեր</span>
        </div>
      </div>
          ...
          <div className="lg:col-span-2">
            {activeTab === 'about' && (
              <div className="space-y-4 text-sm text-gray-700 leading-relaxed">
                <p>
                  Հիփոթեքային վարկը նախատեսված է բնակարանի, առանձնատան, բնակելի անշարժ գույքի ձեռքբերման համար: Ծրագրի շրջանակում քոապագա բնակարանը կարող ես ընտրել ինչպես առաջնային, այնպես էլ երկրորդային շուկայից: Երկու դեպքում էլ անհրաժեշտ է ունենալ կանխավճար` <strong className="text-gray-900">10%-ից</strong> սկսած:
                </p>
                <p>
                  Ընտրելով <strong className="text-purple-700">Evocabank</strong>-ը` կխնայես գումարն ու ժամանակը: Վարկի ձևակերպման համար անհրաժեշտ փաստաթղթերը ներկայացնելուց հետո Evocabank-ը վարկի տրամադրման որոշումը կկայացնի ամենասեղմ ժամկետներում:
                </p>
              </div>
            )}
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 space-y-6 h-fit">
            ...
            <div className="border-b border-gray-100 pb-4 flex justify-between items-center">
              <div>
                ...
                <div className="text-2xl font-black text-purple-800">45 մլն. ֏</div>
              </div>
            ...
            <div className="border-b border-gray-100 pb-4 flex justify-between items-center">
              <div>
                <span className="text-xs text-gray-400 block">մինչև</span>
                <div className="text-2xl font-black text-purple-800">240 ամիս</div>
              </div>
            ...
            <div className="flex justify-between items-center">
              <div>
                ...
                <div className="text-2xl font-black text-purple-800">12%-ից</div>
              </div>
      ...
      <section className="w-full my-12">
        <div
          ...
          style={{
            backgroundImage: `url('https://www.evoca.am/images-cache/loans/1/16142450957093/1920x527.jpg')`,
          }}
        >
          {/* Text Overlay */}
          <div className="text-center text-white px-4 max-w-3xl z-10">
            <h3 className="text-2xl sm:text-3xl md:text-4xl font-extrabold drop-shadow-md leading-tight">
              Խոշոր ձեռքբերումներ ունենալու համար երկար տարիներ խնայելու և սպասելու կարիք այլևս չկա։
            </h3>
          </div>
        </div>
      </section>
