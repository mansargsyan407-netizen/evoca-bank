...
export default function DepositSecuredLoanPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-800 font-sans relative">
      ...
      <section className="bg-gradient-to-r from-purple-900 via-purple-800 to-indigo-900 text-white relative overflow-hidden rounded-b-[40px]">
        <div className="max-w-7xl mx-auto px-6 py-12 md:py-16 grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
          ...
          <div className="md:col-span-7 space-y-4 z-10">
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-black leading-tight tracking-tight">
          ...
          <div className="md:col-span-5 flex justify-center relative">
              <img
                src="	https://www.evoca.am/images-cache/loans/1/16142658362632/560x400.png"
                alt="Deposit Secured Loan"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start mb-12">
          ...
          <div className="lg:col-span-7 space-y-4 text-gray-700 text-sm md:text-base leading-relaxed">
            {activeTab === 'about' && (
              <>
                <p>
                  <span className="text-purple-700 font-bold">Evocabank</span>-ում ներդրված ավանդ ունեք և չնախատեսված ծախսերի կատարման համար ցանկանում եք վաղաժամկետ խզե՞լ այն: Մի՛ մոռացեք, որ դրա հետևանքով կկորցնեք ավանդի նկատմամբ հաշվարկված տոկոսագումարները:
                </p>

                <p>
                  Շահավետ պայմաններով <span className="text-purple-700 font-bold underline cursor-pointer">սպառողական վարկ</span> ձևակերպելու համար այլևս ստիպված չեք լինի հավելյալ ժամանակ տրամադրել գրավադրման առարկա կամ վարկը երաշխավորող անձ փնտրելու համար: <span className="text-purple-700 font-bold">Evocabank</span>-ում ավանդ ունեցող Հաճախորդներին մենք առաջարկում ենք ավանդի գրավով ապահովված վարկային սահմանաչափ` ներդրված ավանդի մինչև 95%-ի չափով: Այն տրամադրվում է հաշված րոպեների ընթացքում` առանց հավելյալ փաստաթղթերի պահանջի: Ամեն ինչ շատ պարզ է, հեշտ և արագ:
                </p>

                <p>
                  Վարկի այս տեսակի շնորհիվ Դուք կպահպանեք ավանդային հաշվին առկա տոկոսագումարները` ստանալով վարկային սահմանաչափ, որը կարող եք օգտագործել մինչև ավանդային պայմանագրի ժամկետի ավարտը:
                </p>
              </>
            )}
            ...
            {activeTab === 'terms' && (
              <div className="p-4 bg-gray-50 rounded-xl border border-gray-100">
                <h3 className="font-bold text-purple-900 mb-2">Պայմաններ</h3>
                <p className="text-sm text-gray-600">
                  Մանրամասն տեղեկությունների համար կարող եք դիմել Բանկի մասնաճյուղեր կամ զանգահարել 8444 հեռախոսահամարով:
                </p>
              </div>
            )}
          </div>
          ...
          <div className="lg:col-span-5 bg-white border border-purple-100 rounded-2xl p-6 shadow-xl shadow-purple-500/5 space-y-6">
            ...
            <div className="space-y-5 divide-y divide-gray-100">
              ...
              <div className="flex items-baseline justify-between pt-2">
                <div>
                  <span className="text-xs text-gray-400 block mb-1">ավանդի գումարի մինչև</span>
              ...
              <div className="flex items-baseline justify-between pt-4">
                <div>
                  <span className="text-xs text-gray-400 block mb-1">պարտատոմսի գումարի մինչև</span>
                  <div className="text-3xl font-black text-purple-900">
                    80%
                  </div>
                </div>
      ...
      {/* Custom Promo Banner Section (Before Other Loans) */}
      <section className="w-full relative h-[280px] md:h-[360px] my-10 overflow-hidden flex items-center justify-center">
        <img
          src="https://www.evoca.am/images-cache/loans/1/16142658362642/1920x527.jpg"
          alt="Կատարե՛ք խնայողություններ՝ վստահելով միայն Evocabank-ին:"
          className="absolute inset-0 w-full h-full object-cover"
        />
        <div className="absolute inset-0 bg-sky-900/10"></div>
        <div className="relative z-10 text-center px-4">
          <h2 className="text-2xl md:text-4xl font-extrabold text-white drop-shadow-md max-w-3xl leading-tight">
