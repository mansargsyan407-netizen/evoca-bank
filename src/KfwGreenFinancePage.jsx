...
export default function KfwGreenFinancePage() {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-800 font-sans relative">
        ...
        <div className="max-w-7xl mx-auto px-6 py-12 md:py-16 grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
          ...
          <div className="md:col-span-7 space-y-4 z-10">
            ...
            <p className="text-gray-600 text-sm md:text-base leading-relaxed max-w-2xl">
              Եթե ցանկանում եք իրականացնել Էներգաարդյունավետ և Էներգախնայող ներդրումներ բիզնեսի ծախսերը կրճատելու և արդյունավետությունը բարձրացնելու նպատակով, այս ֆինանսավորումը Ձեզ համար է:
            </p>
          </div>
          ...
          <div className="md:col-span-5 flex justify-center relative">
              <img
                src="	https://www.evoca.am/images-cache/loans/1/16148706367365/560x400.png"
                alt="KFW Green Finance"
      ...
      <main className="max-w-6xl mx-auto px-6 py-8">
        ...
        {/* Tab Content & Right Specifications Card */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start mb-12">
          ...
          <div className="lg:col-span-7 space-y-6 text-gray-700 text-sm md:text-base leading-relaxed">
            {activeTab === 'about' && (
              <>
                <p>
                  Օգտվեք <span className="text-purple-700 font-bold">Evocabank</span>-ի վարկերից և լիզինգից բացառիկ պայմաններով KFW-ի կողմից տրամադրվող ֆինանսավորվող ծրագրի շրջանակում:
                </p>

                <div>
                  <p className="font-bold text-gray-900 mb-3">Ծրագրի շրջանակում ֆինանսավորվում են՝</p>
                  <ul className="space-y-3 pl-4 list-disc marker:text-purple-700">
                    <li>
                      Վերականգնվող էներգիայի էլեկտրակայանների կառուցման, վերակառուցման և ընդլայնման նախագծերը՝ <span className="text-purple-700 font-bold">տարեկան անվանական տոկոսադրույքը 9.5%</span> (փաստացի տոկոսադրույք մինչև 10%)
                    </li>
                    <li>
                      Էներգաարդյունավետությանն ու էներգախնայողությանն ուղղված ներդրումներ/նախագծեր՝ <span className="text-purple-700 font-bold">տարեկան անվանական տոկոսադրույքը 10.25%</span> (փաստացի տոկոսադրույք մինչև 10.75%)
                    </li>
                  </ul>
                </div>

                <p>
                  Ֆինանսավորումները տրամադրվում են ՀՀ ռեզիդենտ իրավաբանական անձանց և Անհատ ձեռնարկատերերին:
                </p>

                <p>
                  Կանաչ ներդրումները հնարավորություն են տալիս բիզնեսին կրճատել էներգիայի, ջրի և այլ ռեսուրսների ծախսերը, բարձրացնել բիզնեսի արտադրողականությունն ու արդյունավետությունը, ինչպես նաև մրցունակությունը շուկայում:
                </p>

                <div className="space-y-2 pt-2">
                  <p className="font-bold text-purple-800">Evocabank-ում չկա՝</p>
                  <ul className="space-y-2 pl-4 list-disc marker:text-purple-700 text-gray-700">
                    <li>Հայտի ուսումնասիրության վճար</li>
                    <li>Ֆինանսավորման տրամադրման վճար</li>
                    <li>Տուգանք՝ մայր գումարի վաղաժամկետ մարման դեպքում</li>
                  </ul>
                </div>

                <div className="p-4 bg-purple-50/50 rounded-xl border border-purple-100 mt-4">
                  <p className="font-bold text-purple-900 mb-1">Կարևոր</p>
                  <p className="text-xs text-gray-600 leading-relaxed">
                    Մինչև 10 մլն ՀՀ դրամ (ներառյալ) վարկերի տրամադրման համար <span className="text-purple-700 font-bold">գրավային ապահովում չի պահանջվում</span>, միայն իրավաբանական անձ (Անհատ ձեռնարկատեր) կամ ֆիզիկական անձ երաշխավոր, եթե բավարարում է Բանկի վարկավորման պայմաններին:
                  </p>
                </div>
              </>
            )}
            ...
            {activeTab === 'terms' && (
              <div className="p-4 bg-gray-50 rounded-xl border border-gray-100">
                ...
                <p className="text-sm text-gray-600">
                  Մանրամասն սակագներին և պայմաններին ծանոթանալու համար կարող եք այցելել Evocabank-ի մոտակա մասնաճյուղ կամ զանգահարել 8444 հեռախոսահամարով:
                </p>
              </div>
            )}
          </div>

          {/* Right Summary Rates Card Widget */}
          <div className="lg:col-span-5 bg-white border border-purple-100 rounded-2xl p-6 shadow-xl shadow-purple-500/5 space-y-5">
            
            {/* Currency Badge */}
            <div className="flex gap-2">
              <span className="w-9 h-9 rounded-full font-bold text-sm bg-purple-700 text-white flex items-center justify-center shadow-md">
                ֏
              </span>
            </div>
            ...
            <div className="space-y-4 divide-y divide-gray-100">
              ...
              <div className="flex items-baseline justify-between pt-2">
                <div>
                  <span className="text-xs text-gray-400 block mb-0.5">առանց գրավի մինչև</span>
                  <div className="text-2xl font-black text-purple-900">
                    10 մլն․ ֏
                  </div>
                </div>
                <div className="text-xs font-semibold text-gray-500 text-right max-w-[150px]">
                  Սահմանաչափ (ներառյալ)
                </div>
              </div>
              ...
              <div className="flex items-baseline justify-between pt-3">
                ...
                <div className="text-xs font-medium text-gray-600 text-right max-w-[180px]">
                  Տարեկան անվանական տոկոսադրույքը ՎԷԷԿ դեպքում (փաստացի տոկոսադրույք մինչև 10%)
                </div>
              </div>
              ...
              <div className="flex items-baseline justify-between pt-3">
                ...
                <div className="text-xs font-medium text-gray-600 text-right max-w-[180px]">
                  Տարեկան անվանական տոկոսադրույքը ԷԱՆ դեպքում (փաստացի տոկոսադրույք մինչև 10.75%)
                </div>
              </div>
