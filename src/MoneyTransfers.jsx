  ...
  const accordionItems = [
    {
      ...
      content: [
        'Մեզ մոտ գործող վճարահաշվարկային համակարգնապահովում է արագ և հուսալի դրամային փոխանցումներ ինչպես մեր համակարգում, այնպես էլ հայաստանյան այլ բանկերի միջև:',
    ...
    },
    {
      ...
      content: [
        'Իրականացվում են SWIFT համակարգի միջոցով արտարժույթով փոխանցումներ աշխարհի ցանկացած կետ:'
      ]
    },
    {
      title: 'Վճարային համակարգեր',
      content: [
        'Արագ դրամական փոխանցումների համակարգերով փոխանցումների սպասարկում առանց հաշվի բացման:'
      ]
    },
    {
      title: 'Փոխանցման պայմանների փոփոխում կամ չեղյալացում',
      content: [
        'Փոխանցման պայմանների փոփոխումը կամ չեղյալացումը կատարվում է հաճախորդի դիմումի համաձայն:'
      ]
    }
  ];
    ...
    <div className="bg-white min-h-screen text-gray-800 font-sans pb-16">
      ...
      <div className="bg-[#6b21a8] text-white shadow-md">
        <div className="max-w-7xl mx-auto px-4 md:px-8 flex items-center overflow-x-auto font-semibold text-xs md:text-sm">
          {/* Ակտիվ կետ՝ Դրամական փոխանցումներ */}
          <Link
            to="/transfers/money"
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 pt-6">
        ...
        <div className="text-xs text-gray-500 mb-6 flex items-center space-x-2">
          ...
          <span>›</span>
          <span className="hover:underline cursor-pointer">Փոխանցումներ</span>
          <span>›</span>
          <span className="text-gray-800 font-medium">Դրամական փոխանցումներ</span>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mb-12">
          <div className="bg-gray-50/80 p-8 md:p-10 rounded-3xl space-y-4">
            ...
            <p className="text-xs md:text-sm text-gray-600 leading-relaxed font-medium">
              Իրականացնում ենք դրամական փոխանցումներ Հայաստանի տարածքում և դեպի արտերկիր՝ դրամով և արտարժույթով: Փոխանցումներն իրականացվում են միջազգային բանկային ստանդարտներին համապատասխան համակարգերով:
            </p>
          </div>
        ...
        {/* 4. Ընդհանուր դրույթներ (Նկար 1 և 2) */}
        <div className="max-w-5xl mx-auto space-y-5 text-xs md:text-sm text-gray-700 leading-relaxed font-medium mb-12">
      ...
      {/* 5. Լայն ֆոնով նկարով բլոկ (Նկար 3) */}
      <div 
        className="w-full bg-cover bg-center py-20 my-12 relative flex items-center justify-center text-center"
        style={{
          backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.45), rgba(0, 0, 0, 0.45)), url('https://www.evoca.am/images-cache/menu/1/1611294541215/1920x530.jpg')`
        }}
      >
        <div className="max-w-4xl mx-auto px-4 text-white">
          <h2 className="text-lg md:text-2xl font-black leading-relaxed tracking-wide">
            Կարող եք գումարներ փոխանցել ինչպես ձեր հաշվից, այնպես էլ առանց հաշվի բացման:
          </h2>
        </div>
      </div>

      {/* 6. Անհրաժեշտ տեղեկատվություն & Փաստաթղթեր (Նկար 4) */}
      <div className="max-w-5xl mx-auto px-4 md:px-8 space-y-10">
          ...
          <div className="space-y-3">
            {accordionItems.map((item, index) => (
              ...
              >
                ...
                {openAccordion === index && (
                  <div className="p-4 md:p-5 pt-0 bg-white text-xs md:text-sm text-gray-600 font-medium space-y-2 border-t border-purple-50">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            <div className="bg-purple-50/60 hover:bg-purple-100/70 transition p-4 rounded-2xl flex items-center space-x-3 cursor-pointer">
              <span className="text-purple-700 text-xl">📄</span>
              <span className="text-xs md:text-sm font-bold text-gray-800">
                Միջազգային վճարման հանձնարարականներով փոխանցումների իրականացման կանոններ
              </span>
            </div>
