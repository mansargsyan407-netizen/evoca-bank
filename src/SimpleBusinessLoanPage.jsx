        ...
        <div className="max-w-7xl mx-auto px-6 py-12 md:py-16 grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
          ...
          <div className="md:col-span-7 space-y-4 z-10">
            ...
            <p className="text-gray-600 text-sm md:text-base leading-relaxed max-w-2xl">
              Ստացեք Պարզ բիզնես վարկ՝ անշարժ գույքի ապահովմամբ և ցածր տարեկան տոկոսադրույքով: Վարկի տրամադրման վերաբերյալ որոշումը կայացվում է ընդամենը 2-4 աշխատանքային օրվա ընթացքում:
            </p>
          </div>
          ...
          <div className="md:col-span-5 flex justify-center relative">
              <img
                src="	https://www.evoca.am/images-cache/loans/1/16148692298305/560x400.png"
                alt="Պարզ բիզնես վարկ"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start mb-12">
          ...
          <div className="lg:col-span-7 space-y-4 text-gray-700 text-sm md:text-base leading-relaxed">
            {activeTab === 'about' && (
              <>
                <p>
                  <span className="text-purple-700 font-bold underline cursor-pointer">Վարկատեսակից</span> կարող են օգտվել առնվազն 6 ամիս գործունեություն ծավալող իրավաբանական և անհատ ձեռնարկատեր անձինք:
                </p>

                <p>
                  Գրավադրված գույքի տեղակայումից կախված վարկ/գրավ հարաբերակցությունը կարող է լինել գույքի գնահատված արժեքի <span className="text-purple-700 font-bold">50-65%-ի</span> չափով:
                </p>

                <p>
                  Վարկերը կարող եք ձևակերպել մեր Գլխամասային գրասենյակում և ցանկացած մասնաճյուղում (բացառությամբ «Էրեբունի» մասնաճյուղի):
                </p>
              </>
            )}
