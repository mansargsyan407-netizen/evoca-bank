...
const EvocaHome = () => {
  ...
  const termsList = [
    ...
    },
    {
      ...
      content: '21-65 տարեկան ՀՀ ռեզիդենտ ֆիզիկական անձինք',
    },
    {
      id: 3,
      title: 'Սահմանաչափ',
      content: '500,000 - 10,000,000 ՀՀ դրամ',
    },
    {
      id: 4,
      title: 'Սահմանաչափի տեսակ',
      content: 'Չվերականգնվող',
    },
    {
      id: 5,
    ...
    {
      id: 8,
      title: 'Փաստացի տոկոսադրույք',
      content: '17.42%',
    },
    {
      id: 9,
      title: 'Արտոնյալ ժամանակահատված',
      content: 'Չի տրամադրվում',
    },
    {
      id: 10,
      title: 'Մարման ժամկետ',
    ...
    <div className="min-h-screen bg-gray-50 text-gray-800 font-sans">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between">
          <div className="md:w-1/2 z-10">
            ...
            <p className="text-gray-600 text-sm leading-relaxed max-w-lg">
              Ցանկանո՞ւմ ես վերանորոգել բնակարանդ կամ պլանավորո՞ւմ ես գնել նոր կահույք։ Evoca-ի
              կողմից առաջարկվող նոր օվերդրաֆտի միջոցով դու կստեղծես քո երազանքների
              բնակարանը՝ ամենահարմար պայմաններով։
            </p>
          </div>

        <img src="https://www.evoca.am/images-cache/loans/1/17198124761408/560x400.png" alt="" />
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between text-xs text-gray-500">
        ...
        <div className="flex items-center space-x-2">
          ...
          <span>Վարկեր</span>
          <span>›</span>
          <span className="font-semibold text-gray-700">Վերանորոգման վարկ EvocaHOME</span>
        </div>
      </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {/* Left Side Content (Tab Content) */}
          <div className="lg:col-span-2">
            {activeTab === 'about' ? (
              <div className="space-y-6 text-sm text-gray-700 leading-relaxed">
                <p>
                  Նոր վերանորոգված ու կահավորված բնակարան... Ինչի՞ց, որտեղի՞ց կամ ինչպե՞ս սկսել։
                </p>
                <p>
                  <strong className="text-purple-700">Evocabank</strong>-ն առաջին անգամ Հայաստանում առաջարկում է նոր օվերդրաֆտ՝ նախատեսված բնակարանի վերանորոգման կամ կահավորման համար։
                </p>
                <p>
                  Օվերդրաֆտը ձեռք բերելու համար պետք է ունենալ առնվազն 1 տարի գործող հիփոթեքային վարկ ինչպես առաջնային, այնպես էլ երկրորդային շուկայից։
                </p>
                <p>
                  Դե ինչ, շտապիր առաջինը ձեռք բերել շուկայում իր տեսակով առաջին պրոդուկտը՝{' '}
                  <strong className="text-purple-700">EvocaHOME</strong> օվերդրաֆտը։
                </p>
              </div>
            ) : (
              /* Terms Tab Content */
              <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm divide-y divide-gray-100">
                {termsList.map((item) => (
                  <div key={item.id} className="p-5 flex flex-col sm:flex-row sm:items-start space-y-2 sm:space-y-0 text-sm">
                    ...
                    <div className="sm:w-2/3 text-gray-600 leading-relaxed whitespace-pre-line pl-5 sm:pl-0">
                      {item.content}
                    </div>
                  </div>
                ))}
          ...
          {/* Right Summary Card */}
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 space-y-6 h-fit sticky top-6">
            ...
            <div className="border-b border-gray-100 pb-4">
              <span className="text-xs text-gray-400 block">Մինչև</span>
              <div className="text-2xl font-black text-purple-800">60 ամիս</div>
              <span className="text-xs text-gray-500 font-medium">Մարման ժամկետ</span>
            </div>

            <div>
              <div className="text-2xl font-black text-purple-800">16%</div>
              <span className="text-xs text-gray-500 font-medium">Տոկոսադրույք</span>
            </div>
          </div>
        </div>

        {/* Contact Form Section */}
        <section className="mt-16 max-w-xl mx-auto bg-white p-8 rounded-2xl border border-gray-100 shadow-sm">
          <h3 className="text-xl font-bold text-gray-800 mb-6">
            EvocaHOME Հետադարձ կապ
          </h3>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2.5 border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-purple-600 transition"
              />
            </div>
            ...
            <div>
              <label className="block text-xs font-semibold text-gray-700 mb-1">
                Բջջ. հեռ. <span className="text-red-500">*</span>
              </label>
              <div className="flex">
                <span className="inline-flex items-center px-3 border border-r-0 border-gray-200 rounded-l-lg bg-gray-50 text-xs text-gray-600">
                  🇦🇲 +374 ▾
                </span>
                <input
                  type="tel"
                  ...
                  onChange={handleInputChange}
                  className="w-full px-3 py-2.5 border border-gray-200 rounded-r-lg text-sm focus:outline-none focus:border-purple-600 transition"
                />
              </div>
            </div>
            ...
            <button
              type="submit"
              className="w-full bg-purple-700 text-white font-bold py-3 rounded-lg hover:bg-purple-800 transition text-sm shadow-md"
            >
              Ուղարկել
            </button>
          </form>
