...
export default function AdidasNewsPage() {
  return (
    <div className="w-full bg-white text-[#333333] font-sans min-h-screen relative">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-12">
        ...
        <div className="px-4 md:px-8 py-4 text-xs text-gray-500 flex items-center gap-2">
          ...
          <span>›</span>
          <span>Վճարիր Evoca Mastercard-ով Adidas Armenia-ում և ստացիր 10% զեղչ</span>
        </div>
          ...
          <div className="bg-[#fcfbfe] rounded-3xl p-8 lg:p-12 flex flex-col justify-between space-y-6">
            <div className="space-y-4">
              ...
              <p className="text-gray-600 text-sm sm:text-base leading-relaxed pt-2">
                Ունե՞ս Evoca Mastercard, ուրեմն մինչև սեպտեմբերի 1-ը Adidas Armenia-ում ունես 10% զեղչ ամբողջ տեսականու համար:
              </p>
            </div>
        ...
        <section className="max-w-4xl mx-auto space-y-8 text-sm md:text-base leading-relaxed text-gray-700">
          ...
          <p>
            Անկախ նրանից՝ նոր մարզակոշիկներ ես փնտրում, թարմացնում ես սպորտային զգեստապահարանդ, թե պարզապես սիրում ես Adidas բրենդը, հիմա գնումներդ կարող ես կատարել ավելի շահավետ:
          </p>

          <p>
            <strong className="text-[#6b21a8] font-bold">Մինչև սեպտեմբերի 1-ը</strong> բոլոր <strong className="text-[#6b21a8] font-bold">Evoca Mastercard քարտապաններն</strong> ունեն <strong className="text-[#6b21a8] font-bold">10% զեղչ Adidas Armenia</strong>-ում: Զեղչից օգտվելու համար՝ ընդամենը պետք է վճարել <strong className="text-[#6b21a8] font-bold">Evoca Mastercard</strong>-ով խանութ-սրահում:
          </p>
          ...
          <div className="space-y-4 pt-2">
            ...
            <ul className="space-y-3 pl-2">
              <li className="flex items-start gap-3">
                ...
                <span>գործում է բոլոր <strong className="text-gray-900 font-bold">Evoca Mastercard քարտապանների համար</strong>,</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-2 h-2 rounded-full bg-[#6b21a8] mt-2 shrink-0"></span>
                <span>զեղչը գործում է Adidas Armenia-ի <strong className="text-gray-900 font-bold">ամբողջ տեսականու համար</strong>,</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-2 h-2 rounded-full bg-[#6b21a8] mt-2 shrink-0"></span>
                <span>չի տարածվում արդեն <strong className="text-gray-900 font-bold">զեղչված ապրանքների վրա</strong>,</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-2 h-2 rounded-full bg-[#6b21a8] mt-2 shrink-0"></span>
                <span>գործում է մինչև <strong className="text-gray-900 font-bold">01.09.2026</strong>-ը:</span>
              </li>
            </ul>
          </div>
          ...
          <div className="pt-6 space-y-2">
            <p>
              Դեռ չունե՞ս <Link to="/travel-card" className="text-[#6b21a8] underline font-bold">Evoca Mastercard</Link> քարտ, ձեռք բեր այն հիմա և օգտվիր հատուկ առաջարկներից ու ակցիաներից:
            </p>
          </div>
