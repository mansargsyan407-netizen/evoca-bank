...
export default function KfwSmePage() {
    ...
    <div className="min-h-screen bg-white text-gray-800 font-sans relative">
      ...
      <section className="bg-slate-50 text-gray-900 relative overflow-hidden rounded-b-[40px] border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6 py-12 md:py-16 grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
          ...
          <img src="	https://www.evoca.am/images-cache/loans/1/16394873850545/560x400.png" alt="" />
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start mb-12">
          ...
          <div className="lg:col-span-7 space-y-4 text-gray-700 text-sm md:text-base leading-relaxed">
            {activeTab === 'about' && (
              <>
                <p>
                  Ծրագրի հիմնական նպատակն է ապահովել ՄՓՄՁ-ների իրացվելիությունը` բարելավելով նրանց համար ազգային արժույթով վարկերի հասանելիությունը: Ծրագիրն ուղղված չէ տնտեսության որևէ կոնկրետ ճյուղի կամոլորտի (ոլորտների) վարկերի վերաֆինանսավորմանը:
                </p>

                <p>
                  Այն պետք է ծառայի տնտեսության ամենատարբեր ճյուղերում բիզնեսի ընթացիկ կարիքների (շրջանառու միջոցները) և ներդրումների ֆինանսավորմանը (մեքենաներ, սարքավորումներ, ձեռնարկությունների շինություններ և այլն):
                </p>
              </>
            )}
          ...
          <div className="lg:col-span-5 bg-white border border-purple-100 rounded-2xl p-6 shadow-xl shadow-purple-500/5 space-y-6">
            ...
            <div className="flex gap-2">
              <span className="w-8 h-8 rounded-full font-bold text-sm flex items-center justify-center bg-purple-700 text-white shadow-sm">
                ֏
              </span>
            </div>
