      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8 pt-6">
        <div className="flex flex-wrap items-center space-x-4 text-xs text-gray-500 mb-8">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span>›</span>
            <span className="text-gray-800 font-medium">Ավանդ Evoca Online</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start mb-16">
          ...
          <div className="lg:col-span-7 space-y-4 text-sm text-gray-700 leading-relaxed">
            <p>
              Ավանդն ընդունվում է ֆիզիկական անձանցից' բացառապես <span className="text-purple-700 font-bold underline cursor-pointer">EvocaTOUCH</span> և <span className="text-purple-700 font-bold underline cursor-pointer">EvocaONLINE</span> հեռակառավարման համակարգերի միջոցով:
            </p>
            <p>
              Բացի այն, որ մենք խնայում ենք Ձեր ժամանակը, նաև 1 տարի և ավել ժամկետով <span className="text-purple-700 font-bold underline cursor-pointer">ավանդ</span> ձևակերպելու դեպքում առաջարկում ենք մեր գործող տոկոսադրույքից <span className="font-bold">0.25 %-ով</span> բարձր տոկոսադրույք:
            </p>
            <p>
              Որպես Բանկի ավանդատու' Դուք նաև բացարձակապես անվճար կստանաք <span className="text-purple-700 font-bold underline cursor-pointer">միջազգային քարտ</span>:
            </p>
            <p>
            ...
            <div className="divide-y divide-gray-100 space-y-4">
              ...
              <div className="flex justify-between items-center pt-4">
                <div>
                  ...
                  <span className="text-xl font-black text-purple-700">10.75% ֏</span>
                </div>
...
export default EvocaOnlineDeposit;