...
export default function AmchamArmeniaPage() {
  return (
      ...
      <div>
        ...
        <div className="max-w-7xl mx-auto px-6 pt-6 pb-4">
          ...
          <div className="text-[11px] text-gray-400 flex items-center gap-1.5 mb-6">
            ...
            <span>›</span>
            <span className="hover:underline">Բանկային</span>
            <span>›</span>
            <span className="text-gray-600 font-medium truncate max-w-[250px]">Evocabank-ը միացել է AmCham Armenia-ին</span>
          </div>
        </div>
            ...
            <div className="lg:col-span-6 p-8 lg:p-14 flex flex-col justify-between space-y-6">
              <div className="space-y-4">
                <div className="flex items-center gap-2">
                  <span className="w-3.5 h-3.5 bg-[#6b21a8] inline-block"></span>
                  <span className="text-xs font-bold text-gray-900">Բանկային</span>
                </div>
                ...
                <p className="text-xs md:text-sm text-gray-600 leading-relaxed">
                  Evocabank-ը միացել է Ամերիկայի առևտրի պալատը Հայաստանում ՀԿ-ին (ԱԱՊՀ)՝ ընդլայնելով միջազգային համագործակցության հարթակները։
                </p>
              </div>
              <p className="text-xs text-gray-400 font-medium">10.02.2026</p>
            </div>

            {/* Right side image / banner graphic */}
            <div className="lg:col-span-6 bg-[#2d1b4e] relative min-h-[320px] flex items-center justify-center p-8 overflow-hidden">
              <div className="text-center space-y-4">
           <img src="https://www.evoca.am/images-cache/news/1/17707319421286/780x585.png" alt="" />
        ...
        <main className="max-w-4xl mx-auto px-6 pb-20 relative">
          {/* Floating Share Icons (Desktop left sidebar) */}
          ...
          <div className="space-y-6 text-sm md:text-base text-gray-700 leading-relaxed">
            <p>
              <strong className="text-gray-900 font-bold">AmCham Armenia</strong>-ն, հանդիսանալով երկրի առաջատար բիզնես ասոցիացիա, 25 տարի շարունակ համախմբում է տնտեսության տարբեր ոլորտները ներկայացնող առաջատար ընկերությունների։ Իր հիմնադրման օրվանից ի վեր (2000թ.)՝ <strong className="text-gray-900 font-bold">AmCham Armenia</strong>-ին այժմ անդամակցում են ավելի քան 170 անդամ ընկերություններ։
            </p>

            <p>
              Նպաստելով բիզնես և ներդրումային միջավայրի զարգացմանը, ինչպես նաև ամերիկյան և հայկական գործարար համայնքների միջև կապերի ամրապնդմանը՝ <strong className="text-gray-900 font-bold">AmCham Armenia</strong>-ն կապում է պետական և մասնավոր օղակները՝ ներկայացնելով իր անդամների շահերը և խթանելով ավելի արդյունավետ բիզնես միջավայրի ստեղծումը Հայաստանում։
            </p>

            <p>
              <strong className="text-purple-900 font-bold">Evocabank</strong>-ի Վարչության նախագահ <strong className="text-gray-900 font-bold">Կարեն Եղիազարյանը</strong> իր խոսքում նշել է. <em className="italic text-gray-800">«AmCham Armenia-ի հետ համագործակցության շրջանակում մենք հույս ունենք ստեղծել հնարավորություններ, որոնք կնպաստեն Հայաստանի բիզնես էկոհամակարգի զարգացմանը և կաջակցեն նորարար ընկերությունների աճին: Evocabank-ում մենք հավատում ենք համագործակցության ուժին և պլանավորում ենք մեր ներդրումն ունենալ՝ խթանելով ֆինանսական հաստատությունների և բիզնեսների միջև ավելի խորքային գործընկերությունը»։</em>
            </p>

            <p>
              <strong className="text-gray-900 font-bold">AmCham Armenia</strong>-ին անդամակցությունը կստեղծի նոր հնարավորություններ <strong className="text-purple-900 font-bold">Evocabank</strong>-ի համար՝ խթանելով միջազգային փորձի փոխանակումը, բիզնես կապերի ընդլայնումը, տեղական ու միջազգային գործընկերների հետ արդյունավետ համագործակցությունը և Հայաստանում մրցունակ ու ժամանակակից ֆինանսական միջավայրի ձևավորումը։
            </p>
          </div>
        </main>
      </div>
