      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8 pt-6">
        <div className="flex flex-wrap items-center space-x-4 text-xs text-gray-500 mb-8">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span>›</span>
            <span className="text-gray-800 font-medium">Մանկական ավանդ</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start mb-16">
          ...
          <div className="lg:col-span-7 space-y-4 text-sm text-gray-700 leading-relaxed">
            <p>
              Որպես ավանդատու կարող են հանդես գալ ինչպես երեխաների օրինական ներկայացուցիչները (ծնողները, խնամակալները), այնպես էլ երրորդ անձինք: <span className="text-purple-700 font-bold underline cursor-pointer">Ավանդն</span> ընդունվում է ֆիզիկական անձանցից, հօգուտ երեխաների <span className="text-purple-700 font-bold underline cursor-pointer">Ավանդ</span> ներդնելու պայմանով' 2 տարուց մինչև երեխայի 18 տարին լրանալը:
            </p>
            <p>
              Ավանդը կարող է համալրվել' սկսած նվազագույնը 40,000 ՀՀ դրամից կամ 100 ԱՄՆ դոլարից: Տոկոսագումարների վճարումը կամ կապիտալացումը կարող է իրականացվել ամենամյա պարբերականությամբ:
            </p>
            <p>
            ...
            <div className="divide-y divide-gray-100 space-y-4">
              ...
              <div className="flex justify-between items-center pt-4">
                <div>
                  ...
                  <span className="text-xl font-black text-purple-700">18 լրանալը</span>
                </div>
              ...
              <div className="flex justify-between items-center pt-4">
                <div>
                  <span className="text-xl font-black text-purple-700">9.5% ֏</span>
                </div>
              ...
              <div className="flex justify-between items-center pt-4">
                <div>
                  <span className="text-[10px] text-gray-400 block uppercase font-medium">սկսած</span>
                  <span className="text-xl font-black text-purple-700">40,000 ֏</span>
                </div>
...
export default MankakanDeposit;