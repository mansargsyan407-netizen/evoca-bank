...
export default function LosAngelesTimesPage() {
  return (
      ...
      <div>
        ...
        <div className="max-w-7xl mx-auto px-6 pt-6 pb-4">
          ...
          <div className="text-[11px] text-gray-400 flex items-center gap-1.5 mb-6">
            ...
            <span>›</span>
            <span className="hover:underline">Հարցազրույցներ</span>
            <span>›</span>
            <span className="text-gray-600 font-medium truncate max-w-[250px]">
              Կարեն Եղիազարյանի հարցազրույցը Los Angeles Times ամսագրին
            </span>
          </div>
        </div>
            ...
            <div className="lg:col-span-6 p-8 lg:p-14 flex flex-col justify-between space-y-6">
              <div className="space-y-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-bold text-gray-900">Հարցազրույցներ</span>
                </div>
                <h1 className="text-3xl md:text-4xl lg:text-5xl font-black text-gray-900 leading-tight">
                  Կարեն Եղիազարյանի հարցազրույցը Los Angeles Times ամսագրին
                </h1>
                <p className="text-xs md:text-sm text-gray-600 leading-relaxed">
                  LA Times ամսագրի համարում Evocabank-ի Վարչության նախագահ Կարեն Եղիազարյանը խոսել է Բանկի ռազմավարության և թվային նորարարությունների մասին:
                </p>
              </div>
              <p className="text-xs text-gray-400 font-medium">25.02.2026</p>
            </div>

            {/* Right side image */}
            <div className="lg:col-span-6 relative min-h-[320px] bg-gray-900 overflow-hidden flex items-center justify-center">
              <img 
                src="https://www.evoca.am/images-cache/news/1/17720089281517/450x295.png" 
                alt="Կարեն Եղիազարյանի հարցազրույցը Los Angeles Times" 
        ...
        <main className="max-w-4xl mx-auto px-6 pb-20 relative">
          ...
          <div className="space-y-6 text-sm md:text-base text-gray-700 leading-relaxed">
            <p>
              <strong className="text-purple-900 font-bold">Evocabank</strong>-ի Վարչության նախագահ <strong className="text-purple-900 font-bold">Կարեն Եղիազարյանը</strong> միջազգային <strong className="text-purple-900 font-bold">Los Angeles Times</strong> ամսագրի հետ հարցազրույցում անդրադարձել է Բանկի «mobile-first» ձևաչափին, թվային լուծումների կարևորությանը և հաճախորդակենտրոն մոդելի ձևավորմանը՝ ժամանակակից բանկային փորձառություն ապահովելու նպատակով:
            </p>

            <p className="pt-4">
              Ամբողջական հոդվածը՝ <a href="#" className="text-purple-700 font-bold hover:underline">այստեղ</a>:
            </p>
          </div>
        </main>
      </div>
