...
export default function BusinessRefinancingPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-800 font-sans relative">
      ...
      <div className="fixed left-0 top-1/2 -translate-y-1/2 bg-gray-200/80 p-2 rounded-r-md flex flex-col gap-3 text-gray-600 z-10 shadow-sm">
      ...
      {/* Hero Banner Section */}
      <section className="bg-gradient-to-r from-purple-900 via-purple-800 to-indigo-900 text-white relative overflow-hidden rounded-b-[40px]">
        <div className="max-w-7xl mx-auto px-6 py-12 md:py-16 grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
          ...
          <div className="md:col-span-7 space-y-4 z-10">
            ...
            <p className="text-purple-100 text-sm md:text-base leading-relaxed max-w-2xl opacity-90">
              Տեղափոխեք Ձեր բիզնես վարկը Evocabank, ստացեք վարկի վերաֆինանսավորում և լրացուցիչ ֆինանսավորում՝ ավելի հարմար պայմաններով։
            </p>
          </div>

          {/* Right Image/Banner Graphic */}
          <div className="md:col-span-5 flex justify-center relative">
            <div className="relative w-full max-w-md aspect-4/3 bg-purple-600/20 rounded-2xl flex items-center justify-center p-6 border border-purple-400/20 backdrop-blur-sm shadow-2xl">
              <img
                src="https://www.evoca.am/images-cache/loans/1/17822121684763/415x261.png"
                alt="Բիզնես վարկերի վերաֆինանսավորում"
      ...
      <main className="max-w-6xl mx-auto px-6 py-8">
        ...
        {activeTab === 'about' && (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-7 space-y-6 text-gray-700 text-sm md:text-base leading-relaxed">
              <p>
                Ունե՞ք գործող բիզնես վարկ, օվերդրաֆտ կամ վարկային գիծ այլ ֆինանսական կառույցում, կարող եք այն տեղափոխել <strong className="text-purple-700">Evocabank</strong> և միաժամանակ ստանալ հավելյալ միջոցներ՝ Ձեր բիզնեսի ընթացիկ ծախսերի կամ զարգացման նպատակների համար։
              </p>

              <div>
                <h3 className="font-bold text-purple-700 text-base mb-3">Առավելություններ՝</h3>
                <ul className="space-y-3 pl-2">
                  <li className="flex items-start gap-2">
                    <span className="text-purple-600 font-bold text-lg leading-none">•</span>
                    <span>
                      Վերաֆինանսավորվող վարկի գումարի <strong>մինչև 2%-ի չափով cashback</strong> (cashback-ի առավելագույն չափը՝ մինչև 2,000,000 ՀՀ դրամ կամ համարժեք արտարժույթ),
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-purple-600 font-bold text-lg leading-none">•</span>
                    <span><strong>մինչև 120 ամիս</strong> մարման ժամկետ,</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-purple-600 font-bold text-lg leading-none">•</span>
                    <span>մայր գումարի մարման արտոնյալ ժամանակահատված՝ <strong>մինչև 6 ամիս</strong>,</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-purple-600 font-bold text-lg leading-none">•</span>
                    <span><strong>լրացուցիչ ֆինանսավորման</strong> հնարավորություն,</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-purple-600 font-bold text-lg leading-none">•</span>
                    <span>ֆինանսավորում <strong>ՀՀ դրամով, ԱՄՆ դոլարով կամ եվրոյով</strong>:</span>
                  </li>
                </ul>
              </div>

              <div>
                <h3 className="font-bold text-purple-700 text-base mb-3">
                  Լրացուցիչ ֆինանսավորումը կարող ես օգտագործել՝
                </h3>
                <ul className="space-y-3 pl-2">
                  <li className="flex items-start gap-2">
                    <span className="text-purple-600 font-bold text-lg leading-none">•</span>
                    <span>հիմնական միջոցների ձեռքբերման,</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-purple-600 font-bold text-lg leading-none">•</span>
                    <span>շրջանառու միջոցների համալրման,</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-purple-600 font-bold text-lg leading-none">•</span>
                    <span>կրեդիտորական պարտքերի մարման,</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-purple-600 font-bold text-lg leading-none">•</span>
                    <span>ընթացիկ ծախսերի կամ այլ ներդրումների համար։</span>
                  </li>
                </ul>
              </div>

              <p className="pt-2 text-gray-600">
                <strong className="text-purple-700">Evocabank</strong>-ի հետ կարող եք ոչ միայն ավելի հարմար պայմաններով վերաֆինանսավորել Ձեր գործող վարկերը, այլ նաև ստանալ նոր հնարավորություններ՝ Ձեր բիզնեսն ընդլայնելու համար:
              </p>
            </div>

            {/* Right Column Metric Table Card */}
            <div className="lg:col-span-5 bg-white border border-gray-100 rounded-2xl p-6 shadow-xl space-y-4">
              ...
              <div className="divide-y divide-gray-100">
                <div className="py-3 flex justify-between items-center">
                  <div>
                    <span className="text-[11px] text-gray-400 font-medium block">Վերաֆինանսավորում</span>
                    <span className="text-2xl font-black text-purple-700">36-120 ամիս</span>
                  </div>
                ...
                <div className="py-3 flex justify-between items-center">
                  <div>
                    <span className="text-[11px] text-gray-400 font-medium block">Գումար</span>
                    <span className="text-xl font-black text-purple-700">15մլն - 500մլն</span>
                  </div>
                ...
                <div className="py-3 flex justify-between items-center">
                  <div>
                    <span className="text-[11px] text-gray-400 font-medium block">Սկսած</span>
                    <span className="text-xl font-black text-purple-700">ՀՀ դրամ՝ 12%</span>
                  </div>
                  <span className="text-xs font-semibold text-gray-500 text-right max-w-[140px]">
                ...
                <div className="py-3 flex justify-between items-center">
                  <div>
                    <span className="text-[11px] text-gray-400 font-medium block">Սկսած</span>
                    <span className="text-xl font-black text-purple-700">ԱՄՆ դոլար՝ 9%</span>
                  </div>
                  <span className="text-xs font-semibold text-gray-500 text-right max-w-[140px]">
                    Տարեկան անվանական տոկոսադրույք
                  </span>
                ...
                <div className="py-3 flex justify-between items-center">
                  <div>
                    <span className="text-[11px] text-gray-400 font-medium block">Սկսած</span>
                    <span className="text-xl font-black text-purple-700">Եվրո՝ 8%</span>
                  </div>
                  <span className="text-xs font-semibold text-gray-500 text-right max-w-[140px]">
                    Տարեկան անվանական տոկոսադրույք
                  </span>
        ...
        {/* Tab 2: Terms Placeholder */}
        {activeTab === 'terms' && (
          <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm text-gray-600">
            <p>Վարկի տրամադրման մանրամասն պայմաններին և սակագներին կարող եք ծանոթանալ այստեղ:</p>
          </div>
        )}
        ...
        <section className="mt-16">
          ...
          >
            {otherLoans.map(({ icon: Icon, img, title }) => (
              <a
                key={title}
                href="#"
