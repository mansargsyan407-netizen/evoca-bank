...
export default function AjapnyakBranchPage() {
  return (
      ...
      <div>
            ...
            <div className="lg:col-span-6 p-8 lg:p-14 flex flex-col justify-between space-y-6">
              <div className="space-y-4">
                ...
                <p className="text-xs md:text-sm text-gray-600 leading-relaxed">
                  Հունվարի 12-ին բացվեց Evocabank-ի նոր՝ «Աջափնյակ» մասնաճյուղը, Աբելյան 2/1 հասցեում:
                </p>
              </div>
              <p className="text-xs text-gray-400 font-medium">12.01.2026</p>
            </div>

            {/* Right side image */}
            <div className="lg:col-span-6 relative min-h-[320px] bg-gray-900 overflow-hidden flex items-center justify-center">
              <img 
                src="https://www.evoca.am/images-cache/news/1/17683825017248/450x295.jpg" 
                alt="Evocabank-ի Աջափնյակ մասնաճյուղ" 
        ...
        <main className="max-w-4xl mx-auto px-6 pb-20 relative">
          ...
          <div className="space-y-6 text-sm md:text-base text-gray-700 leading-relaxed">
            <p>
              Այսուհետ <strong className="text-purple-900 font-bold">Evocabank</strong>-ի հաճախորդները կսպասարկվեն նորաբաց <strong className="text-purple-900 font-bold">«Աջափնյակ» մասնաճյուղի</strong> հարմարավետ և նորագույն տեխնիկայով հագեցած սրահում:
            </p>

            <p>
              Բանկի աշխատակիցները հաճախորդներին կմատուցեն ֆինանսական մի շարք ծառայություններ՝
            </p>

            <ul className="list-disc pl-6 space-y-2 text-gray-700">
              <li>Ֆիզիկական և իրավաբանական անձանց սպասարկում,</li>
              <li>Վարկերի տրամադրում և ավանդների ներգրավում,</li>
              <li>Անհատական պահատուփերի տրամադրում,</li>
              <li>Բանկային փոխանցումների իրականացում (ՀՀ տարածքում, դեպի արտերկիր, ՀՀ պետական բյուջե),</li>
              <li>Արտարժույթի փոխանակում,</li>
              <li>Կանխիկ դրամարկղային գործարքներ և այլն:</li>
            </ul>

            <h3 className="text-lg font-bold text-purple-900 pt-4">
              «Աջափնյակ» մասնաճյուղի աշխատանքային ժամերն են՝
            </h3>

            <ul className="list-disc pl-6 space-y-2 text-gray-700">
              <li>Երկուշաբթիից ուրբաթ՝ ժամը <strong className="text-gray-900">09:30-17:00</strong></li>
            </ul>
          </div>
        </main>
      </div>
