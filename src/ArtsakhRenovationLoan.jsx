    ...
    <div className="min-h-screen bg-gray-50 text-gray-800 font-sans">
      ...
      <section className="bg-purple-50 relative overflow-hidden py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between">
          ...
          <div className="md:w-1/2 mt-8 md:mt-0 flex justify-end">
            <div className="w-full max-w-md h-64 bg-purple-200/50 rounded-3xl flex items-center justify-center relative shadow-sm overflow-hidden p-4">
              {/* House Construction Illustration */}
              <div className="text-center relative">
                <span className="text-8xl drop-shadow-md">🏠🛠️</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between text-xs text-gray-500">
        ...
        <div className="flex items-center space-x-2 flex-wrap">
          ...
          <span>Վարկեր</span>
          <span>›</span>
          <span className="font-semibold text-gray-700">Վերանորոգման հիփոթեքային վարկ Արցախից տեղահանված ընտանիքներին</span>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            {activeTab === 'about' && (
              <div className="space-y-5 text-sm text-gray-700 leading-relaxed">
                <p>
                  Հիփոթեքային վարկը տրամադրվում է Արցախի առանձին շրջաններից տեղահանված ընտանիքների համար բնակարանային մատչելիությանապահովման պետական աջակցության ծրագրով ձեռքբերված բնակարանի կամ անհատական բնակելի տան վերանորոգման նպատակով:
                </p>

                <p className="font-bold text-purple-700">
                  Մենք ստեղծել ենք ամենահարմար պայմանները՝ առաջարկելով արագ ու մատչելի լուծումներ:
                </p>
              </div>
            )}
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 space-y-6 h-fit">
            ...
            <div className="flex justify-between items-center">
              <div>
                <div className="text-2xl font-black text-purple-800">13%</div>
              </div>
...
export default ArtsakhRenovationLoan;