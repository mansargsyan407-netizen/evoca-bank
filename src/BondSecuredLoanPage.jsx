...
export default function BondSecuredLoanPage() {
        ...
        <div className="max-w-7xl mx-auto px-6 py-12 md:py-16 grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
          ...
          <div className="md:col-span-5 flex justify-center relative">
            <div className="relative w-full max-w-md aspect-4/3 bg-purple-600/20 rounded-2xl flex items-center justify-center p-6 border border-purple-400/20 backdrop-blur-sm shadow-2xl">
              <img
                src="https://www.evoca.am/images-cache/loans/1/17848707149538/415x261.png"
                alt="Պարտատոմսերով ապահովված վարկ"
      ...
      <main className="max-w-6xl mx-auto px-6 py-8">
        ...
        <div className="border-b border-gray-200 mb-8">
          <div className="flex gap-8">
            <button className="pb-3 font-bold text-sm text-purple-700 border-b-2 border-purple-700">
              Վարկի մասին
            </button>
          </div>
        </div>
        ...
        {/* Content Body */}
        <div className="max-w-4xl space-y-6 text-gray-700 text-sm md:text-base leading-relaxed">
          <p>
          ...
          <p>
            Դիմել կարող են Բանկի պարտատոմսերում ներդրում կատարած իրավաբանական անձինք և անհատ ձեռնարկատերերը: Վարկը տրամադրվում է օնլայն՝ ՀՀ դրամով, մինչև պարտատոմսերի անվանական արժեքի 80%-ը (ՀՀ դրամով) կամ մինչև 70%-ը (արտարժույթով):
          </p>
          <p className="font-semibold text-purple-800 pt-2">
