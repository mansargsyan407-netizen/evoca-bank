...
const YoungFamilyLoan = () => {
  const [activeTab, setActiveTab] = useState('about');

// Պայմանների տվյալներ
  const termsList = [
    { id: 1, title: 'Վարկի նպատակը', content: 'Բնակելի տան կառուցապատում Ազգային հիփոթեքային ընկերության ծրագրի ներքո սահմանված չափանիշներին համապատասխան:' },
    ...
    { id: 3, title: ' Վարկառու', content: 'Վարկառուն պետք է լինի կառուցվող բնակելի անշարժ գույքի  և հողամասի սեփականատերը, որի վրա կառուցվում/կառուցվել է բնակելի անշարժ գույքը: ' },
    { id: 4, title: 'Տեսակները', content: 'Կառուցապատման ստանդարտ վարկեր' },
    { id: 5, title: 'Վարկավորման արժույթը', content: 'ՀՀ դրամ' },
    { id: 6, title: ' Վարկավորման գումար', content: '2 000 000- 35 000 000' },
        { id: 7, title: 'Վարկի մարման ժամկետը', content: '120 –  240 ամիս' },
                { id: 8, title: 'Վարկի գումարը պայմանագրով ամրագրված ժամանակացույցից շուտ մարելու համար վճարվող տուգանք', content: '    Տուգանք չի կիրառվում' },
 { id: 9, title: 'Վարկի գումարների և տոկոսագումարների մարման ժամկետների ուշացման դեպքում վճարվող տույժեր', content: 'ժամկետանց վարկի համար՝ օրական 0.015%,' },
 { id: 10, title: 'Վարկի մարման ձևը', content: 'Անուիտետային կամ մայր գումարի հավասարաչափ մարումներով վարկ. վճարումները պետք է կատարվեն ամսական կտրվածքով։' },
  ];


    // Պահանջվող փաստաթղթեր
  const documentsList = [
    'Հիփոթեքային վարկի տրամադրման դիմում-հայտ',
  ...
  'տեղեկանք աշխատանքի վայրից աշխատավարձի չափի մեծության մասին,որի տրամադրման ժամկետը Բանկին ներկայացման օրվա դրությամբ չպետք է գերազանցի 30 օրացույցային օրը' ,
  'Հաճախորդի ինքնազբաղված լինելու դեպքում`Պետական ռեգիստրի գրանցման վկայական կամ պետական ռեգիստրի կողմից տրված՝ քաղվածք գրանցամատյանից,Հարկ վճարողի հաշվառման համարը (ՀՎՀՀ), եթե առկա չէ պետական ռեգիստրի վկայականում կամ քաղվածքում',
  'այլ եկամուտների մեծությունը հավաստող տեղեկատվություն (առկայության դեպքում)',
  'կառուցապատվող անշարժ գույքի / հողամասի գնահատման հաշվետվություն',
  'կառուցապատվող անշարժ գույքի սեփականության վկայականը',
'անշարժ գույքի սեփականատերերի անձնագրերը',
'տեղեկատվություն՝ երաշխավորող անձի/անց վերաբերյալ (պահանջի դեպքում)',
'Վերանորոգման դեպքում կատարվելիք ծախսերի նախահաշիվ',
'Բանկի պահանջով այլ փաստաթղթեր`կատարվելիք ծախսերի նախահաշիվ, հողի սեփականության վկայական, շինարարության թույլտվություն, կառուցվող անշարժ գույքի նախագիծ։ Այլ փաստաթղթեր բանկի պահանջով:',
];
    ...
    <div className="min-h-screen bg-gray-50 text-gray-800 font-sans">
      ...
      <section className="bg-purple-50 relative overflow-hidden py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between">
          ...
          <img src="https://www.evoca.am/images-cache/loans/1/16142451699156/560x400.png" alt="" />
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between text-xs text-gray-500">
        ...
        <div className="flex items-center space-x-2">
          ...
          <span>Վարկեր</span>
          <span>›</span>
          <span className="font-semibold text-gray-700">Հիփոթեքային վարկ «Երիտասարդ ընտանիքին՝ մատչելի բնակարան»</span>
        </div>
      </div>
          ...
          <div className="lg:col-span-2">
            {activeTab === 'about' && (
              <div className="space-y-5 text-sm text-gray-700 leading-relaxed">
                <p>
                  «Երիտասարդ ընտանիքին՝ մատչելի բնակարան» ծրագրի շրջանակներում Evocabank-ը առաջարկում է <strong className="text-purple-700 underline decoration-purple-500">հիփոթեքային վարկեր</strong> ամենաշահավետ պայմաններով: Եթե Ձեր և Ձեր ամուսնու հանրագումարային տարիքը չի գերազանցում 70-ը, և ունեք բավարար եկամուտներ ու դրական վարկային պատմություն,ապա հենց այս ծրագրի օգնությամբ կարող եք ձեռք բերել Ձեր նախընտրած բնակարանն ինչպես Երևանում, այնպես էլ ՀՀ մարզերում:
                </p>

                <div className="space-y-2 pt-2">
                  <p className="font-semibold text-gray-800">Գործում է նաև՝</p>
                  <ul className="space-y-2 pl-4">
                    <li className="flex items-start space-x-2">
                      <span className="w-2 h-2 rounded-full bg-purple-700 mt-1.5 flex-shrink-0"></span>
                      <span><strong>2% սուբսիդավորում</strong>, ք. Երևանում բնակելի անշարժ գույքի ձեռքբերման դեպքում,</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <span className="w-2 h-2 rounded-full bg-purple-700 mt-1.5 flex-shrink-0"></span>
                      <span><strong>4% սուբսիդավորում</strong>, ՀՀ մարզերում բնակելի անշարժ գույքի ձեռքբերման դեպքում:</span>
                    </li>
                  </ul>
                </div>

                <p>
                  Երկրորդային շուկայից բնակելի անշարժ գույքի գնման համար անհրաժեշտ է ունենալ կանխավճար սկսած <strong>10%-ից</strong>, իսկ առաջնային շուկայից անշարժ գույքի գնման դեպքում անհրաժեշտ է ունենալ կանխավճար <strong>7.5%-ից</strong> սկսած:
                </p>

                <p>
                  Ձեր վարկունակությունը բավարար չէ՞ վարկի ստացման համար, մենք այդ մասին էլ ենք մտածել: Ձեր վարկային պարտավորությունները Ձեզ հետ միասին կարող է ստանձնել նաև համավարկառուն: Որպես համավարկառուներ կարող են հանդիսանալ Ձեր ընտանիքի անդամները (ըստ ընտանիքի անդամներ են համարվում՝ ամուսինը, վարկառուի և նրա ամուսնու ծնողները, քույրերը և եղբայրները):
                </p>
              </div>
            )}
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 space-y-6 h-fit">
            ...
            <div className="border-b border-gray-100 pb-4 flex justify-between items-center">
              <div>
                ...
                <div className="text-2xl font-black text-purple-800">27 մլն. ֏</div>
              </div>
            ...
            <div className="border-b border-gray-100 pb-4 flex justify-between items-center">
              <div>
                <span className="text-xs text-gray-400 block">մինչև</span>
                <div className="text-2xl font-black text-purple-800">180 ամիս</div>
              </div>
              <span className="text-xs text-gray-600 font-semibold">Վարկի մարման ժամկետը</span>
            </div>

            <div className="border-b border-gray-100 pb-4 flex justify-between items-center">
              <div>
                <div className="text-2xl font-black text-purple-800">2-ից - 4%</div>
              </div>
              <span className="text-xs text-gray-600 font-semibold">Սուբսիդավորվող տոկոս</span>
            </div>

            <div className="flex justify-between items-center">
              <div>
                <div className="text-2xl font-black text-purple-800">6.9-ից - 7.9%</div>
              </div>
      ...
      <section className="w-full my-12">
        <div
          ...
          style={{
            backgroundImage: `url('https://www.evoca.am/images-cache/loans/1/16142451699219/1920x527.jpg')`,
          }}
        >
          ...
          <div className="text-center text-white px-4 max-w-3xl z-10 space-y-2">
            <h3 className="text-2xl sm:text-3xl md:text-4xl font-extrabold drop-shadow-md leading-tight">
              Նոր բնակարան ունենալն այլևս երազանք չէ: Կառուցե'ք ամուր տանիք Evocabank-ի օգնությամբ:
            </h3>
          </div>
        </div>
      </section>
...
export default YoungFamilyLoan;