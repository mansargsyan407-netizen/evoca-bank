...
const ArtsakhDisplacedLoan = () => {
  const [activeTab, setActiveTab] = useState('about');

  // Պայմանների տվյալներ
  const termsList = [
    { id: 1, title: 'Վարկավորման նպատակը', content: 'ՀՀ-ում բնակելի նշանակության անշարժ գույքի` բնակարանի, անհատական բնակելի տան (առաջնային և երկրորդային շուկայից) ձեռքբերում կամ կառուցապատում:' },
    { id: 2, title: 'Ովքեր կարող են դիմել', content: 'Հավաստագրում ներառված անձը կամ նրա ընտանիքի անդամը: Վարկառուի տարիքային շեմը հաշվի չի առնվում, եթե գործում առկա է համավարկառու, ում 65 տարեկանը չի բոլորի վարկի սպասարկման ողջ ընթացքում:' },
    { id: 3, title: 'Ծրագրի շահառուներ', content: 'Կառավարության 2022 թ․ փետրվարի 17-ի N 169-L որոշման 4-րդ հոդվածով սահմանված անձիք' },
    { id: 4, title: 'Վարկավորման արժույթը', content: 'ՀՀ դրամ' },
    { id: 5, title: 'Վարկավորման գումար', content: '2,000,000.00-30,000,000.00 ՀՀ դրամ' },
    { id: 6, title: 'Վարկի մարման ժամկետը', content: '120 ամիս' },
  ];
    ...
    <div className="min-h-screen bg-gray-50 text-gray-800 font-sans">
      ...
      <section className="bg-purple-50 relative overflow-hidden py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between">
          ...
          <div className="md:w-1/2 mt-8 md:mt-0 flex justify-end">
           <img src="	https://www.evoca.am/images-cache/loans/1/16690389589063/560x400.png" alt="" />
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between text-xs text-gray-500">
        ...
        <div className="flex items-center space-x-2 flex-wrap">
          ...
          <span>Վարկեր</span>
          <span>›</span>
          <span className="font-semibold text-gray-700">Հիփոթեքային վարկ Արցախի շրջաններից տեղահանված ընտանիքներին</span>
        </div>
      </div>
          ...
          <div className="lg:col-span-2">
            {activeTab === 'about' && (
              <div className="space-y-5 text-sm text-gray-700 leading-relaxed">
                <p>
                  <strong className="text-purple-700 border-b border-purple-700 pb-0.5">Հիփոթեքային վարկը</strong> տրամադրվում է Արցախի առանձին շրջաններից տեղահանված ընտանիքների համար բնակարանային մատչելիությանապահովման պետական աջակցության ծրագրով ՀՀ-ում բնակելի նշանակության անշարժ գույքի՝ բնակարանի, անհատական բնակելի տան (առաջնային և երկրորդային շուկայից) ձեռքբերման կամ բնակելի տան կառուցապատման նպատակով:
                </p>
              </div>
            )}
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 space-y-6 h-fit">
            ...
            <div className="flex justify-between items-center">
              <div>
                ...
                <div className="text-2xl font-black text-purple-800">10%-ից</div>
              </div>
...
export default ArtsakhDisplacedLoan;